...
$resourceSha256 = 'C51E5224E6919E31A2D8835ED674ED088C5F644AC8DDA394AE5D162C05062440'
$resourceLength = 2566
$metadata = @(
...
$requiredFields = @(
    ...
    'MANAGED_HTTPS_PHASE43_DECOMPRESSED_BYTES=0x0000000000000A0A',
    'MANAGED_HTTPS_PHASE43_TEXT_INPUT_BYTES=0x0000000000000A0A',
    ...
    'MANAGED_HTTPS_PHASE43_BODY_HANDLE=0x0000000000000009',
...
$resourceWords = @('C51E5224','E6919E31','A2D8835E','D674ED08','8C5F644A','C8DDA394','AE5D162C','05062440')
$reports = @()
