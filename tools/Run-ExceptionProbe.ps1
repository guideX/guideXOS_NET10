[CmdletBinding()]
param(
    [ValidateSet('Positive', 'ContinueSearch')]
...
$requiredPositive = @(
    ...
    'GXOS_NET10:EXCEPTION_SYNTHETIC_HANDLER_ENTERED=1',
    'GXOS_NET10:EXCEPTION_SYNTHETIC_HANDLER_CALL_COUNT=0x0000000000000001',
...
$requiredNegative = @(
    ...
    'GXOS_NET10:EXCEPTION_SYNTHETIC_HANDLER_ENTERED=1',
    'GXOS_NET10:EXCEPTION_SYNTHETIC_HANDLER_CALL_COUNT=0x0000000000000001',
    'GXOS_NET10:EXCEPTION_SYNTHETIC_HANDLER_MODE=CONTINUE_SEARCH',
...
for ($i = 1; $i -le $RunCount; $i++) {
    ...
    $required = if ($Mode -eq 'Positive') { $requiredPositive } else { $requiredNegative }
