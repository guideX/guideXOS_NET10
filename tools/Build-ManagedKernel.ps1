...
$exports = @($pe | Select-String -Pattern 'ManagedMain|GxManagedKernelInitialize|GxManagedKernelInstallBootResources|GxManagedQueryBootResources|GxManagedQueryMemoryRegion|GxManagedQuerySystemInfo|GxManagedKernelInstallHostServices|GxManagedKernelInstallMemoryServices|GxManagedKernelInstallDeviceInventory|GxManagedQueryDeviceInventorySummary|GxManagedQueryDevice|GxManagedKernelInstallPciServices|GxManagedKernelStart|GxManagedKernelRunPhase4|GxManagedKernelRunPhase5|GxManagedKernelRunPhase6|GxManagedKernelRunPhase7|GxManagedKernelInstallSerialServices|GxManagedKernelRunPhase8|GxManagedKernelInstallInterruptServices|GxManagedKernelRunPhase9|GxManagedKernelRunDriverWorker|GxManagedKernelRunPhase10' | ForEach-Object { $_.Line.Trim() })
