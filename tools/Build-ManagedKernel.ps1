...
$exports = @($pe | Select-String -Pattern 'ManagedMain|GxManagedKernelInitialize|GxManagedKernelInstallBootResources|GxManagedQueryBootResources|GxManagedQueryMemoryRegion|GxManagedQuerySystemInfo|GxManagedKernelInstallHostServices|GxManagedKernelInstallMemoryServices|GxManagedKernelInstallDeviceInventory|GxManagedQueryDeviceInventorySummary|GxManagedQueryDevice|GxManagedKernelInstallDeviceResources|GxManagedQueryDeviceResourceSummary|GxManagedQueryDeviceResource|GxManagedKernelInstallPciServices|GxManagedKernelStart|GxManagedKernelRunPhase4|GxManagedKernelRunPhase5|GxManagedKernelRunPhase6|GxManagedKernelRunPhase7|GxManagedKernelInstallSerialServices|GxManagedKernelRunPhase8|GxManagedKernelInstallInterruptServices|GxManagedKernelInstallInputServices|GxManagedKernelRunPhase9|GxManagedKernelRunDriverWorker|GxManagedKernelRunPhase10|GxManagedKernelRunPhase11|GxManagedKernelRunPhase12' | ForEach-Object { $_.Line.Trim() })
