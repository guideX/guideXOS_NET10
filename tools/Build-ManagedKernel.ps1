...
$exports = @($pe | Select-String -Pattern 'ManagedMain|GxManagedKernelInitialize|GxManagedKernelInstallBootResources|GxManagedQueryBootResources|GxManagedQueryMemoryRegion|GxManagedQuerySystemInfo|GxManagedKernelInstallHostServices|GxManagedKernelInstallMemoryServices|GxManagedKernelStart|GxManagedKernelRunPhase4' | ForEach-Object { $_.Line.Trim() })
...
Write-Output 'MANAGED_KERNEL_EXPORTS=ManagedMain,GxManagedKernelInitialize,GxManagedKernelInstallBootResources,GxManagedQueryBootResources,GxManagedQueryMemoryRegion,GxManagedQuerySystemInfo,GxManagedKernelInstallHostServices,GxManagedKernelInstallMemoryServices,GxManagedKernelStart,GxManagedKernelRunPhase4'
