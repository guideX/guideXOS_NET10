...
$exports = @($pe | Select-String -Pattern 'ManagedMain|GxManagedKernelInitialize|GxManagedKernelInstallBootResources|GxManagedQueryBootResources|GxManagedQueryMemoryRegion|GxManagedQuerySystemInfo|GxManagedKernelInstallHostServices|GxManagedKernelInstallMemoryServices|GxManagedKernelInstallDeviceInventory|GxManagedQueryDeviceInventorySummary|GxManagedQueryDevice|GxManagedKernelStart|GxManagedKernelRunPhase4|GxManagedKernelRunPhase5|GxManagedKernelRunPhase6' | ForEach-Object { $_.Line.Trim() })
