...
internal static unsafe class ManagedKernelContract
{
    ...
    private static int s_phase42Mode;
    private static int s_phase43Mode;
    ...
    private static int s_phase50Mode;
    ...
    internal static uint RunPhase14(uint stage)
    {
        ...
        if (stage == 7)
        {
            ...
            if (!ManagedVirtioRngKernelProof.TryStartPhase35Provider())
                return InvalidState;
            s_phase42Mode = 1;
            ManagedE1000Driver.EnablePhase42Mode();
            return ManagedOk;
        }
        if (stage == 8)
        {
            ...
            if (!ManagedHtmlResourceRequest.PrimeNativeKernelTokenizer())
                return InvalidState;
            s_phase43Mode = 1;
            ManagedE1000Driver.EnablePhase43Mode();
            return ManagedOk;
        }
        if (stage == 9)
        {
            ...
            if (!ManagedHtmlResourceRequest.PrimeNativeKernelTokenizer())
                return InvalidState;
            s_phase43CapacityMode = 1;
            ManagedE1000Driver.EnablePhase43CapacityMode();
            return ManagedOk;
        }
        if (stage == 10)
        {
            ...
            if (!ManagedCssEngine.PrimeNativeKernelArenas())
                return InvalidState;
            s_phase44Mode = 1;
            ManagedE1000Driver.EnablePhase44Mode();
            return ManagedOk;
        }
        if (stage == 11)
        {
        ...
        if (stage == 14)
        {
            ...
            if (!ManagedCssEngine.PrimeNativeKernelArenas())
                return InvalidState;
            s_phase46Mode = 1;
            ManagedE1000Driver.EnablePhase46Mode();
            return ManagedOk;
        }
        if (stage == 15)
        {
        ...
        if (stage == 18)
        {
            ...
            if (!ManagedVirtioRngKernelProof.TryStartPhase35Provider() ||
                ...
                return InvalidState;
            s_phase50Mode = 1;
            ManagedE1000Driver.EnablePhase50Mode();
            return ManagedOk;
        }
        if (stage == 19)
        {
            ...
            if (!ManagedVirtioRngKernelProof.TryStartPhase35Provider() ||
                ...
                return InvalidState;
            s_phase51Mode = 1;
            ManagedE1000Driver.EnablePhase51Mode();
            return ManagedOk;
        }
        if (stage == 20)
        {
            ...
            if (!ManagedVirtioRngKernelProof.TryStartPhase35Provider() ||
                ...
                !ManagedCssEngine.PrimeNativeKernelArenas())
                return InvalidState;
            s_phase51ResetReuseMode = 1;
            ManagedE1000Driver.EnablePhase51ResetReuseMode();
            return ManagedOk;
        }
        if (stage == 21)
        {
        ...
        if (stage == 2)
        {
            ...
            bool phase50Proof = s_phase14Driver.Phase50Passed;
            ...
            if (!KernelLog.Write(rxProof
                ...
                (phase50Proof &&
                 !KernelLog.Write("GXOS_NET10:MANAGED_KERNEL_PHASE50_PASS\r\n"u8)) ||
                (phase51Proof &&
                 !KernelLog.Write("GXOS_NET10:MANAGED_KERNEL_PHASE51_PASS\r\n"u8)) ||
