...
#if defined(GXOS_ENABLE_MANAGED_KERNEL) && defined(GXOS_ENABLE_CREATE_THREAD)
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
#define GXOS_NATIVEAOT_IAT_RVA(rva) ((rva) + 0x1000U)
#else
#define GXOS_NATIVEAOT_IAT_RVA(rva) (rva)
#endif
...
#define EFI_LOCATE_BY_PROTOCOL ((uint32_t)2U)
...
typedef EFI_STATUS (EFIAPI *GXOS_EFI_PCI_GET_LOCATION)(
    void *protocol, EFI_UINTN *segment, EFI_UINTN *bus,
    EFI_UINTN *device, EFI_UINTN *function);
typedef EFI_STATUS (EFIAPI *GXOS_EFI_PCI_GET_BAR_ATTRIBUTES)(
    void *protocol, uint8_t bar_index, uint64_t *supports, void **resources);

/* Only the vtable prefix through GetBarAttributes is named. The preceding
   protocol operations remain opaque, but their slots are retained exactly. */
typedef struct {
    uint64_t Revision;
    void *PollMem;
    void *PollIo;
    ...
    void *FreeBuffer;
    void *Flush;
    GXOS_EFI_PCI_GET_LOCATION GetLocation;
    void *Attributes;
    GXOS_EFI_PCI_GET_BAR_ATTRIBUTES GetBarAttributes;
    void *SetBarAttributes;
} GXOS_EFI_PCI_IO_PROTOCOL;
...
typedef struct {
    ...
    uint64_t address_space_granularity;
    uint64_t address_range_min;
    uint64_t address_range_max;
    uint64_t address_translation_offset;
    uint64_t address_length;
} GXOS_EFI_ACPI_ADDRESS_SPACE_DESCRIPTOR;
#pragma pack(pop)
...
typedef uint32_t (EFIAPI *ManagedKernelQueryBootResourcesEntry)(
    uint32_t requested_abi_version, uintptr_t output_address,
    uintptr_t output_capacity);
typedef uint32_t (EFIAPI *ManagedKernelQueryMemoryRegionEntry)(
...
typedef uint32_t (EFIAPI *ManagedKernelInstallDeviceInventoryEntry)(
    uint32_t requested_abi_version, uintptr_t publication_address);
typedef uint32_t (EFIAPI *ManagedKernelQueryDeviceInventorySummaryEntry)(
    uint32_t requested_abi_version, uintptr_t output_address,
    uintptr_t output_capacity);
typedef uint32_t (EFIAPI *ManagedKernelQueryDeviceEntry)(
    uint32_t requested_abi_version, uint32_t index, uintptr_t output_address,
    uintptr_t output_capacity);
...
typedef uint32_t (EFIAPI *ManagedKernelInstallSerialServicesEntry)(
    uint32_t requested_abi_version, uintptr_t services_address,
...
typedef uint32_t (EFIAPI *ManagedKernelInstallInterruptServicesEntry)(
    uint32_t requested_abi_version, uintptr_t services_address);
typedef uint32_t (EFIAPI *ManagedKernelInstallInputServicesEntry)(
    uint32_t requested_abi_version, uintptr_t services_address,
    uintptr_t device_address);
...
typedef uint32_t (EFIAPI *ManagedKernelRunPhase11Entry)(uint32_t stage);
typedef uint32_t (EFIAPI *ManagedKernelInstallDeviceResourcesEntry)(
    uint32_t requested_abi_version, uintptr_t publication_address);
typedef uint32_t (EFIAPI *ManagedKernelQueryDeviceResourceSummaryEntry)(
    uint32_t requested_abi_version, uintptr_t output_address,
    uintptr_t output_capacity);
typedef uint32_t (EFIAPI *ManagedKernelQueryDeviceResourceEntry)(
    uint32_t requested_abi_version, uint32_t index, uintptr_t output_address,
    uintptr_t output_capacity);
typedef uint32_t (EFIAPI *ManagedKernelRunPhase12Entry)(uint32_t stage);
typedef uint32_t (EFIAPI *ManagedKernelInstallMmioServicesEntry)(
    uint32_t requested_abi_version, uintptr_t services_address);
typedef uint32_t (EFIAPI *ManagedKernelRunPhase13Entry)(uint32_t stage);
#endif
...
static volatile uint64_t g_nativeaot_gc_tick_count;
static volatile uint64_t g_nativeaot_gc_last_unwind_context;
static volatile uint64_t g_nativeaot_gc_last_unwind_context_rsp;
static volatile uint64_t g_nativeaot_gc_last_unwind_context_rip;
static volatile uint64_t g_nativeaot_gc_last_unwind_control_pc;
#endif
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
static GXOS_VM_ARENA g_managed_kernel_mmio_virtual_arena;
#endif
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
/* This is the immutable, native-owned publication backing. It contains
   copies of normalized values, never pointers into the UEFI map or ledger. */
static GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1
    g_managed_kernel_boot_resource_regions[
        GX_MANAGED_KERNEL_BOOT_RESOURCE_MAX_REGIONS];
static GX_MANAGED_KERNEL_BOOT_RESOURCE_SUMMARY_V1
    g_managed_kernel_boot_resource_summary;
static GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1
    g_managed_kernel_boot_resource_publication_storage;
static GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1 *
    g_managed_kernel_boot_resource_publication;
static uint32_t g_managed_kernel_boot_resource_snapshot_ready;
...
static GXOS_MANAGED_KERNEL_PCI_DEVICE_INPUT
    g_managed_kernel_pci_devices[GX_MANAGED_KERNEL_DEVICE_INVENTORY_MAX_DEVICES];
static GX_MANAGED_KERNEL_DEVICE_V1
    g_managed_kernel_device_descriptors[GX_MANAGED_KERNEL_DEVICE_INVENTORY_MAX_DEVICES];
static GX_MANAGED_KERNEL_DEVICE_INVENTORY_SUMMARY_V1
    g_managed_kernel_device_inventory_summary;
static GX_MANAGED_KERNEL_DEVICE_INVENTORY_PUBLICATION_V1
    g_managed_kernel_device_inventory_publication_storage;
static GX_MANAGED_KERNEL_DEVICE_INVENTORY_PUBLICATION_V1 *
...
static GX_MANAGED_KERNEL_DEVICE_RESOURCE_V1
    g_managed_kernel_device_resources[GX_MANAGED_KERNEL_DEVICE_RESOURCE_MAX_DESCRIPTORS];
static GX_MANAGED_KERNEL_DEVICE_RESOURCE_SUMMARY_V1
    g_managed_kernel_device_resource_summary;
static GX_MANAGED_KERNEL_DEVICE_RESOURCE_PUBLICATION_V1
    g_managed_kernel_device_resource_publication_storage;
static GX_MANAGED_KERNEL_DEVICE_RESOURCE_PUBLICATION_V1 *
    g_managed_kernel_device_resource_publication;
static uint32_t g_managed_kernel_device_resource_snapshot_ready;
static GXOS_MMIO_SERVICE g_managed_kernel_mmio_service;
static GXOS_MMIO_CACHE_POLICY g_managed_kernel_mmio_cache_policy;
static GX_MANAGED_KERNEL_MMIO_SERVICES_V1 g_managed_kernel_mmio_services;
static uint32_t g_managed_kernel_mmio_service_ready;
static uint32_t g_managed_kernel_mmio_window_reservation_slot;
static GX_MANAGED_KERNEL_SERIAL_PLATFORM_DEVICE_V1
...
static GX_MANAGED_KERNEL_INPUT_SERVICES_V1
...
static GX_MANAGED_KERNEL_KEYBOARD_STATUS_V1
    g_managed_kernel_keyboard_status;
...
static uint32_t g_managed_kernel_keyboard_interrupt_ioapic_enabled;
static uint32_t g_managed_kernel_keyboard_interrupt_enabled;
static uint32_t g_managed_kernel_keyboard_irq_capture_count;
static uint8_t g_managed_kernel_keyboard_saved_pic_mask;
static uint32_t g_managed_kernel_keyboard_saved_ioapic_low;
static uint32_t g_managed_kernel_keyboard_saved_ioapic_high;
#endif
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
static int managed_kernel_host_range_is_known(uintptr_t address,
                                              uintptr_t byte_length)
{
    uintptr_t image_end;
    uintptr_t stack_end;
    if (byte_length == 0) return 1;
    if (address == 0 || byte_length > UINTPTR_MAX - address) return 0;
    if (g_managed_image_base != 0 && g_managed_image_size != 0 &&
        g_managed_image_base <= UINTPTR_MAX - g_managed_image_size) {
        image_end = (uintptr_t)g_managed_image_base +
            (uintptr_t)g_managed_image_size;
        if (address >= (uintptr_t)g_managed_image_base &&
            address + byte_length <= image_end) return 1;
    }
    if (g_stack_lower != 0 && g_stack_upper > g_stack_lower &&
        g_stack_upper - g_stack_lower <= UINTPTR_MAX) {
        stack_end = (uintptr_t)g_stack_upper;
        if (address >= (uintptr_t)g_stack_lower &&
            address + byte_length <= stack_end) return 1;
    }
    return 0;
}

static int managed_kernel_serial_range_is_known(void *opaque,
                                                uintptr_t address,
                                                uintptr_t byte_length)
{
    uint32_t index;
    ...
    for (index = 0; index != GXOS_MANAGED_KERNEL_MEMORY_SLOT_COUNT; ++index) {
        ...
        uintptr_t base;
        uintptr_t end;
        if (!allocation->live || allocation->virtual_address == 0 ||
            allocation->byte_length == 0 ||
            allocation->byte_length > UINTPTR_MAX -
                (uintptr_t)allocation->virtual_address) {
            continue;
        }
        base = (uintptr_t)allocation->virtual_address;
        end = base + (uintptr_t)allocation->byte_length;
        if (address >= base && address <= end &&
            byte_length <= end - address) return 1;
    }
    return 0;
}

static int managed_kernel_serial_uart_ready(void *opaque)
{
    (void)opaque;
    return (serial_in8(0x3F8 + 5) & 0x20U) != 0;
}

static int managed_kernel_serial_uart_transmit(void *opaque, uint8_t value)
{
    (void)opaque;
    serial_out8(0x3F8, value);
    return 1;
...
static uint32_t GX_MANAGED_KERNEL_MS_ABI managed_kernel_serial_transmit_service(
    uint32_t device_id, uintptr_t buffer_address, uint32_t byte_length,
    uint32_t flags)
{
    return gxos_managed_kernel_serial_write_v1(
        &g_managed_kernel_serial_context, device_id, buffer_address,
        byte_length, flags);
}

static uint32_t GX_MANAGED_KERNEL_MS_ABI managed_kernel_serial_status_service(
    uint32_t requested_abi_version, uint32_t device_id,
    uintptr_t result_address, uintptr_t result_capacity)
{
    return gxos_managed_kernel_serial_query_status_v1(
        &g_managed_kernel_serial_context, requested_abi_version, device_id,
        result_address, result_capacity);
}

static void managed_kernel_host_serial_sink(const uint8_t *bytes,
                                            uintptr_t byte_length)
{
    serial_write(bytes, (EFI_UINTN)byte_length);
}

static uint32_t EFIAPI managed_kernel_host_log_utf8(
    uintptr_t bytes_address, uintptr_t byte_length, uint32_t flags)
{
    GX_MANAGED_STATUS status;
    status = gxos_managed_kernel_host_log_utf8(
        bytes_address, byte_length, flags, managed_kernel_host_serial_sink,
        managed_kernel_host_range_is_known);
    if (status == GX_MANAGED_OK) ++g_managed_kernel_host_log_calls;
    ...
    uintptr_t output_capacity)
{
    ...
    GX_MANAGED_STATUS range_status;
    int64_t ticks;
    int64_t frequency;
    ...
    result.Ticks = (uint64_t)ticks;
    result.FrequencyHz = (uint64_t)frequency;
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
static void fill_bytes(uint8_t *destination, uint8_t value, uint64_t count)
{
...
typedef struct {
    ...
    uint32_t managed_kernel_query_device_rva;
    ...
    uint32_t managed_kernel_install_input_services_rva;
    ...
    uint32_t managed_kernel_run_phase11_rva;
    uint32_t managed_kernel_install_device_resources_rva;
    uint32_t managed_kernel_query_device_resource_summary_rva;
    uint32_t managed_kernel_query_device_resource_rva;
    uint32_t managed_kernel_run_phase12_rva;
    uint32_t managed_kernel_install_mmio_services_rva;
...
static void EFIAPI platform_flush_process_write_buffers(void)
{
    __atomic_thread_fence(__ATOMIC_SEQ_CST);
    ++g_nativeaot_gc_flush_process_write_buffers_calls;
}
...
static uint32_t EFIAPI platform_rtl_virtual_unwind(
    ...
    uint64_t image_base,
    uint64_t control_pc,
    const GXOS_NATIVEAOT_RUNTIME_FUNCTION *function_entry,
    GXOS_CONTEXT_COMPAT *context_record,
    void **handler_data,
    ...
    void *context_pointers)
{
    ...
    for (code_index = 0; code_index < code_count; ) {
        const uint8_t *code = codes + code_index * 2U;
        uint32_t operation = code[1] & 0x0FU;
        uint32_t operation_info = code[1] >> 4;
        uint32_t slots = 1;
        uint64_t value;
...
#else
    serial_field_hex("GXOS_NET10:VIRTUALQUERY_CAPTURE_WORKER_STACK_BASE=0x", 0);
#endif
    serial_text("\r\n");
#ifdef GXOS_ENABLE_MANAGED_KERNEL
...
#else
    serial_field_hex("GXOS_NET10:VIRTUALQUERY_CAPTURE_WORKER_STACK_LIMIT=0x", 0);
#endif
    serial_text("\r\n");
#ifdef GXOS_ENABLE_MANAGED_KERNEL
...
#else
    serial_field_hex("GXOS_NET10:VIRTUALQUERY_CAPTURE_CURRENT_IDENTITY=0x", 0);
#endif
    serial_text("\r\n");
#ifdef GXOS_ENABLE_MANAGED_KERNEL
...
#else
    serial_field_hex("GXOS_NET10:VIRTUALQUERY_CAPTURE_CURRENT_STATE=0x", 0);
#endif
    serial_text("\r\n");
    return result;
}
    ...
    EFI_BOOT_SERVICES *boot_services)
{
    ...
    if (g_crt_free_import_descriptor_index != 9U ||
        ...
        g_crt_free_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D318U)) {
    ...
    uintptr_t import_entry_rsp)
{
    ...
    if (
        ...
        serial_field_hex("GXOS_NET10:CREATETHREAD_POSTCONDITION_START_RVA=0x",
                         start_rva);
        serial_text("\r\n");
...
static void *platform_import_target(const char *module, const char *symbol)
{
    ...
    if (equal_text(module, "KERNEL32.dll") &&
        equal_text(symbol, "FlushProcessWriteBuffers")) {
        return (void *)(uintptr_t)platform_flush_process_write_buffers;
    }
    if (equal_text(module, "KERNEL32.dll") &&
        equal_text(symbol, "RtlVirtualUnwind")) {
        return (void *)(uintptr_t)platform_rtl_virtual_unwind;
    }
#endif
#ifdef GXOS_ENABLE_VECTORED_EXCEPTION_HANDLER
    if (equal_text(module, "KERNEL32.dll") &&
...
static void __attribute__((unused)) activate_nativeaot_tls(void)
{
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
    gxos_vm_arena_init(&g_managed_kernel_mmio_virtual_arena,
                       GXOS_MMIO_WINDOW_BASE, GXOS_MMIO_WINDOW_LENGTH,
                       g_memory_map.generation);
    if (gxos_vm_arena_reserve_fixed(
            &g_managed_kernel_mmio_virtual_arena, GXOS_MMIO_WINDOW_BASE,
            GXOS_MMIO_WINDOW_LENGTH, GXOS_VM_RESERVATION_KIND_MMIO,
            GXOS_MMIO_WINDOW_OWNER, g_memory_map.generation,
            &g_managed_kernel_mmio_window_reservation_slot) !=
            GXOS_VM_STATUS_OK) {
        fail("memory-mmio-window-reservation");
    }
#endif
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
static void initialize_managed_kernel_mmio_service(void)
{
    GXOS_MMIO_CACHE_STATUS cache_status;
    GXOS_MMIO_SERVICE_STATUS service_status;
    cache_status = gxos_mmio_cache_policy_probe(
        &g_managed_kernel_mmio_cache_policy);
    serial_text("GXOS_NET10:MANAGED_KERNEL_MMIO_CACHE_POLICY=PAT_PCD_PWT_UC\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_PAT_SUPPORTED=0x",
                     g_managed_kernel_mmio_cache_policy.pat_supported);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_PAT_MSR=0x",
                     g_managed_kernel_mmio_cache_policy.pat_msr);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_MTRR_DEF_TYPE=0x",
                     g_managed_kernel_mmio_cache_policy.mtrr_default_type);
    serial_text("\r\n");
    if (cache_status != GXOS_MMIO_CACHE_STATUS_OK) {
        serial_text("GXOS_NET10:MANAGED_KERNEL_MMIO_CACHE_POLICY_UNPROVEN=1\r\n");
        gxos_mmio_set_callback_service(&g_managed_kernel_mmio_service);
        return;
    }
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_PTE_FLAGS=0x",
                     g_managed_kernel_mmio_cache_policy.pte_flags);
    serial_text("\r\n");
    service_status = gxos_mmio_service_init(
        &g_managed_kernel_mmio_service, &g_vm_paging,
        &g_managed_kernel_mmio_virtual_arena,
        g_managed_kernel_device_resources,
        g_managed_kernel_device_resource_summary.ResourceCount,
        g_memory_map.generation, &g_memory_map,
        &g_managed_kernel_mmio_cache_policy);
    if (service_status != GXOS_MMIO_SERVICE_OK) {
        serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_SERVICE_BLOCKED=0x",
                         service_status);
        serial_text("\r\n");
        gxos_mmio_set_callback_service(&g_managed_kernel_mmio_service);
        return;
    ...
    gxos_mmio_set_callback_service(&g_managed_kernel_mmio_service);
    g_managed_kernel_mmio_service_ready = 1;
    serial_text("GXOS_NET10:MANAGED_KERNEL_MMIO_CACHE_POLICY_PROVEN\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_WINDOW_BASE=0x",
                     GXOS_MMIO_WINDOW_BASE);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_WINDOW_LENGTH=0x",
                     GXOS_MMIO_WINDOW_LENGTH);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_MAPPING_CAPACITY=0x",
                     GXOS_MMIO_MAPPING_CAPACITY);
    serial_text("\r\n");
}

static void initialize_managed_kernel_mmio_service_table(void)
{
    zero_bytes((uint8_t *)&g_managed_kernel_mmio_services,
               sizeof(g_managed_kernel_mmio_services));
    g_managed_kernel_mmio_services.Size =
        GX_MANAGED_KERNEL_MMIO_SERVICES_V1_SIZE;
    g_managed_kernel_mmio_services.AbiVersion =
        GX_MANAGED_KERNEL_MMIO_SERVICES_ABI_V1;
    g_managed_kernel_mmio_services.ServiceVersion =
        GX_MANAGED_KERNEL_MMIO_SERVICES_VERSION_V1;
    g_managed_kernel_mmio_services.Architecture = GX_MANAGED_KERNEL_ARCH_X64;
    g_managed_kernel_mmio_services.Capabilities =
        GX_MANAGED_MMIO_CAPABILITY_CLAIM |
        GX_MANAGED_MMIO_CAPABILITY_MAP |
        GX_MANAGED_MMIO_CAPABILITY_UNMAP |
        GX_MANAGED_MMIO_CAPABILITY_READ |
        GX_MANAGED_MMIO_CAPABILITY_UNCACHEABLE;
    g_managed_kernel_mmio_services.ClaimAddress =
        (uint64_t)(uintptr_t)&gxos_mmio_claim_callback;
    g_managed_kernel_mmio_services.ReleaseAddress =
        (uint64_t)(uintptr_t)&gxos_mmio_release_callback;
    g_managed_kernel_mmio_services.MapAddress =
        (uint64_t)(uintptr_t)&gxos_mmio_map_callback;
    g_managed_kernel_mmio_services.UnmapAddress =
        (uint64_t)(uintptr_t)&gxos_mmio_unmap_callback;
    g_managed_kernel_mmio_services.ReadAddress =
        (uint64_t)(uintptr_t)&gxos_mmio_read_callback;
    g_managed_kernel_mmio_services.MaxClaims =
        GX_MANAGED_KERNEL_DEVICE_RESOURCE_MAX_CLAIMS;
    g_managed_kernel_mmio_services.MaxMappings = GXOS_MMIO_MAPPING_CAPACITY;
    g_managed_kernel_mmio_services.WindowBase = GXOS_MMIO_WINDOW_BASE;
    g_managed_kernel_mmio_services.WindowLength = GXOS_MMIO_WINDOW_LENGTH;
}

static void prepare_managed_kernel_boot_resources(void)
{
    GXOS_MANAGED_BOOT_RESOURCE_NORMALIZATION_STATUS status;
    zero_bytes((uint8_t *)g_managed_kernel_boot_resource_regions,
               sizeof(g_managed_kernel_boot_resource_regions));
    zero_bytes((uint8_t *)&g_managed_kernel_boot_resource_summary,
               sizeof(g_managed_kernel_boot_resource_summary));
    status = gxos_managed_kernel_normalize_boot_resources(
        &g_memory_map, &g_memory_classification,
        g_managed_kernel_boot_resource_regions,
        GX_MANAGED_KERNEL_BOOT_RESOURCE_MAX_REGIONS,
        &g_managed_kernel_boot_resource_summary);
    if (status != GXOS_MANAGED_BOOT_RESOURCE_NORMALIZATION_OK) {
        fail("managed-kernel-boot-resource-normalization");
    }
    zero_bytes((uint8_t *)&g_managed_kernel_boot_resource_publication_storage,
               sizeof(g_managed_kernel_boot_resource_publication_storage));
    g_managed_kernel_boot_resource_publication =
        &g_managed_kernel_boot_resource_publication_storage;
    g_managed_kernel_boot_resource_snapshot_ready = 1;
    serial_text("GXOS_NET10:MANAGED_KERNEL_BOOT_RESOURCES_NATIVE_SNAPSHOT_READY\r\n");
    serial_field_hex("GXOS_NET10:NATIVE_BOOT_RESOURCE_DESCRIPTOR_COUNT=0x",
                     g_managed_kernel_boot_resource_summary.RegionCount);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:NATIVE_BOOT_RESOURCE_TOTAL_PHYSICAL=0x",
                     g_managed_kernel_boot_resource_summary.TotalPhysicalBytes);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:NATIVE_BOOT_RESOURCE_USABLE_PHYSICAL=0x",
                     g_managed_kernel_boot_resource_summary.UsablePhysicalBytes);
    serial_text("\r\n");
}

static void prepare_managed_kernel_device_inventory(void)
{
    ...
    zero_bytes((uint8_t *)g_managed_kernel_pci_devices,
               sizeof(g_managed_kernel_pci_devices));
    zero_bytes((uint8_t *)g_managed_kernel_device_descriptors,
               sizeof(g_managed_kernel_device_descriptors));
    zero_bytes((uint8_t *)&g_managed_kernel_device_inventory_summary,
               sizeof(g_managed_kernel_device_inventory_summary));
    status = gxos_managed_kernel_discover_pci_devices(
        gxos_managed_kernel_pci_config_read32, 0,
        g_managed_kernel_pci_devices,
        GX_MANAGED_KERNEL_DEVICE_INVENTORY_MAX_DEVICES, &device_count);
    if (status != GXOS_MANAGED_KERNEL_DEVICE_INVENTORY_OK) {
        fail("managed-kernel-device-discovery");
    }
    status = gxos_managed_kernel_normalize_device_inventory(
        g_managed_kernel_pci_devices, device_count,
        g_managed_kernel_device_descriptors,
        GX_MANAGED_KERNEL_DEVICE_INVENTORY_MAX_DEVICES,
        &g_managed_kernel_device_inventory_summary);
    if (status != GXOS_MANAGED_KERNEL_DEVICE_INVENTORY_OK ||
        g_managed_kernel_device_inventory_summary.DeviceCount != device_count ||
        g_managed_kernel_device_inventory_summary.ResourceCount != 0U ||
        device_count == 0U) {
    ...
    g_managed_kernel_device_inventory_publication =
        &g_managed_kernel_device_inventory_publication_storage;
    g_managed_kernel_device_inventory_publication->Size =
        GX_MANAGED_KERNEL_DEVICE_INVENTORY_PUBLICATION_V1_SIZE;
    g_managed_kernel_device_inventory_publication->AbiVersion =
        GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1;
    g_managed_kernel_device_inventory_publication->SummaryAddress =
        (uint64_t)(uintptr_t)&g_managed_kernel_device_inventory_summary;
    g_managed_kernel_device_inventory_publication->DescriptorAddress =
        (uint64_t)(uintptr_t)g_managed_kernel_device_descriptors;
    g_managed_kernel_device_inventory_publication->DescriptorCount = device_count;
    g_managed_kernel_device_inventory_publication->DescriptorSize =
        GX_MANAGED_KERNEL_DEVICE_V1_SIZE;
    g_managed_kernel_device_inventory_publication->DescriptorByteLength =
        descriptor_bytes;
    g_managed_kernel_device_inventory_snapshot_ready = 1;
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_NATIVE_SNAPSHOT_READY\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_DISCOVERY=PCI_CONFIG_READ_ONLY\r\n");
    serial_field_hex("GXOS_NET10:NATIVE_DEVICE_COUNT=0x",
                     g_managed_kernel_device_inventory_summary.DeviceCount);
    serial_text("\r\n");
    for (index = 0; index != device_count; ++index) {
        GX_MANAGED_KERNEL_DEVICE_V1 *device =
            &g_managed_kernel_device_descriptors[index];
        serial_field_hex("GXOS_NET10:NATIVE_PCI_DEVICE_INDEX=0x", index);
        serial_text(" BDF=0x");
        serial_hex64(((uint64_t)device->Segment << 32) |
                     ((uint64_t)device->Bus << 24) |
                     ((uint64_t)device->Device << 16) |
                     ((uint64_t)device->Function << 8));
        serial_text(" VENDOR=0x");
        serial_hex64(device->VendorId);
        serial_text(" DEVICE=0x");
        serial_hex64(device->DeviceId);
        serial_text(" CLASS=0x");
        serial_hex64(((uint64_t)device->ClassCode << 16) |
                     ((uint64_t)device->Subclass << 8) |
                     device->ProgrammingInterface);
        serial_text(" HEADER=0x");
        serial_hex64(device->HeaderType);
        serial_text(" BAR_COUNT=0x");
        serial_hex64(device->ResourceCount);
        serial_text("\r\n");
    }
    serial_field_hex("GXOS_NET10:NATIVE_RESOURCE_COUNT=0x",
                     g_managed_kernel_device_inventory_summary.ResourceCount);
    serial_text("\r\n");
}

#ifdef GXOS_ENABLE_MANAGED_KERNEL
static int managed_kernel_query_uefi_pci_bar(
    void *opaque, uint16_t segment, uint8_t bus, uint8_t device,
    uint8_t function, uint8_t bar_index, GXOS_PCI_FIRMWARE_BAR *bar_out)
{
    EFI_BOOT_SERVICES *boot_services = (EFI_BOOT_SERVICES *)opaque;
    EFI_UINTN buffer_size = 0;
    EFI_HANDLE *handles = 0;
    EFI_STATUS status;
    EFI_UINTN handle_count;
    EFI_UINTN handle_index;
    if (bar_out != 0) zero_bytes((uint8_t *)bar_out, sizeof(*bar_out));
    if (boot_services == 0 || boot_services->LocateHandle == 0 ||
        boot_services->HandleProtocol == 0 || boot_services->FreePool == 0 ||
        boot_services->AllocatePool == 0 ||
        bar_out == 0 || bar_index >= 6U) return 0;
    status = boot_services->LocateHandle(EFI_LOCATE_BY_PROTOCOL,
                                         (EFI_GUID *)&gEfiPciIoProtocol, 0,
                                         &buffer_size, 0);
    if (status != EFI_BUFFER_TOO_SMALL || buffer_size == 0 ||
        buffer_size > UINT64_MAX / sizeof(EFI_HANDLE) ||
        EFI_ERROR(boot_services->AllocatePool(
            EFI_LOADER_DATA, buffer_size, (void **)&handles)) || handles == 0) {
        return 0;
    }
    status = boot_services->LocateHandle(EFI_LOCATE_BY_PROTOCOL,
                                         (EFI_GUID *)&gEfiPciIoProtocol, 0,
    ...
    handle_count = buffer_size / sizeof(EFI_HANDLE);
    for (handle_index = 0; handle_index != handle_count; ++handle_index) {
        GXOS_EFI_PCI_IO_PROTOCOL *protocol = 0;
        EFI_UINTN actual_segment = 0;
        EFI_UINTN actual_bus = 0;
        EFI_UINTN actual_device = 0;
        EFI_UINTN actual_function = 0;
        void *resources = 0;
        const uint8_t *cursor;
        uint32_t descriptor_index;
        if (EFI_ERROR(boot_services->HandleProtocol(
                (EFI_HANDLE)handles[handle_index],
                (EFI_GUID *)&gEfiPciIoProtocol, (void **)&protocol)) ||
            protocol == 0 || protocol->GetLocation == 0 ||
            EFI_ERROR(protocol->GetLocation(protocol, &actual_segment,
                                             &actual_bus, &actual_device,
                                             &actual_function))) {
            continue;
        }
        serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_UEFI_BAR_HANDLE_BDF=0x",
                         ((uint64_t)actual_segment << 32) |
                         ((uint64_t)actual_bus << 24) |
                         ((uint64_t)actual_device << 16) |
                         ((uint64_t)actual_function << 8));
        serial_text("\r\n");
        if (actual_segment != segment || actual_bus != bus ||
            actual_device != device || actual_function != function ||
            protocol->GetBarAttributes == 0) {
            continue;
        }
        if (EFI_ERROR(protocol->GetBarAttributes(protocol, bar_index, 0,
                                                  &resources)) ||
            resources == 0) {
            continue;
        }
        serial_text("GXOS_NET10:MANAGED_KERNEL_MMIO_UEFI_BAR_PROTOCOL_MATCH\r\n");
        cursor = (const uint8_t *)resources;
        for (descriptor_index = 0; descriptor_index != 16U; ++descriptor_index) {
            uint8_t descriptor = cursor[0];
            uint16_t descriptor_length = (uint16_t)cursor[1] |
                                         ((uint16_t)cursor[2] << 8);
            if (descriptor == 0x8AU &&
                descriptor_length >= sizeof(GXOS_EFI_ACPI_ADDRESS_SPACE_DESCRIPTOR) - 3U) {
                const GXOS_EFI_ACPI_ADDRESS_SPACE_DESCRIPTOR *address =
                    (const GXOS_EFI_ACPI_ADDRESS_SPACE_DESCRIPTOR *)cursor;
                if (address->resource_type == 0U && address->address_length != 0U &&
                    address->address_range_min <= UINT64_MAX - address->address_length) {
                    bar_out->base = address->address_range_min;
                    bar_out->length = address->address_length;
                    (void)boot_services->FreePool(resources);
                    (void)boot_services->FreePool(handles);
                    return 1;
                }
            }
            if (descriptor == 0x79U) break;
            if ((descriptor & 0x80U) != 0U) {
                cursor += 3U + descriptor_length;
            } else {
                cursor += 1U + (descriptor & 7U);
            }
        }
        (void)boot_services->FreePool(resources);
    }
...
/* OVMF in the canonical q35 image does not bind EFI_PCI_IO_PROTOCOL to the
   emulated e1000 function. The retained firmware memory map still proves that
   the first assigned BAR page does not overlap RAM. A single page is the
   conservative fallback; it is enough for STATUS and is never treated as the
   full device BAR. */
    ...
    uint64_t base, GXOS_PCI_FIRMWARE_BAR *bar_out)
{
    ...
    for (index = 0; index != g_memory_map.descriptor_count; ++index) {
        const EFI_MEMORY_DESCRIPTOR *descriptor =
            gxos_uefi_memory_map_descriptor(&g_memory_map, index);
        uint64_t bytes;
        if (descriptor == 0 || descriptor->NumberOfPages == 0 ||
            descriptor->NumberOfPages > UINT64_MAX / GXOS_VM_PAGE_SIZE) continue;
        if (gxos_memory_class_is_ram_like(
                gxos_memory_class_for_efi_type(descriptor->Type))) {
            bytes = descriptor->NumberOfPages * GXOS_VM_PAGE_SIZE;
            if (base >= descriptor->PhysicalStart &&
                base - descriptor->PhysicalStart <= bytes - GXOS_VM_PAGE_SIZE) {
                return 0;
            }
        }
    }
    bar_out->base = base;
    bar_out->length = GXOS_VM_PAGE_SIZE;
    serial_text("GXOS_NET10:MANAGED_KERNEL_MMIO_BAR_AUTHORITY=UEFI_RAM_EXCLUSION_PAGE\r\n");
    return 1;
}
#endif
    ...
    EFI_BOOT_SERVICES *boot_services)
{
    ...
    zero_bytes((uint8_t *)g_managed_kernel_device_resources,
    ...
    {
        GXOS_MANAGED_KERNEL_DEVICE_INVENTORY_STATUS inventory_status;
        uint32_t device_count = 0;
        uint32_t pci_index;
        inventory_status = gxos_managed_kernel_discover_pci_devices(
            gxos_managed_kernel_pci_config_read32, 0,
            g_managed_kernel_pci_devices,
            GX_MANAGED_KERNEL_DEVICE_INVENTORY_MAX_DEVICES, &device_count);
        if (inventory_status != GXOS_MANAGED_KERNEL_DEVICE_INVENTORY_OK) {
            fail("managed-kernel-resource-pci-discovery");
        }
        for (pci_index = 0; pci_index != device_count; ++pci_index) {
            ...
            for (bar_index = 0; bar_index != 6U; ++bar_index) {
                ...
                uint32_t raw_low = gxos_managed_kernel_pci_config_read32(
                    0, device->segment, device->bus, device->device,
                    device->function, (uint8_t)(0x10U + bar_index * 4U));
                uint32_t raw_high = 0;
                uint64_t raw_base;
                ...
                if ((raw_low & 1U) == 0U && ((raw_low >> 1) & 3U) == 2U) {
                    ...
                    raw_high = gxos_managed_kernel_pci_config_read32(
                        0, device->segment, device->bus, device->device,
                        device->function, (uint8_t)(0x14U + bar_index * 4U));
                }
                raw_base = (uint64_t)(raw_low & 0xFFFFFFF0U) |
                           ((uint64_t)raw_high << 32);
                ...
                bar_status = gxos_managed_kernel_append_pci_mmio_resource(
                    g_managed_kernel_device_resources,
                    GX_MANAGED_KERNEL_DEVICE_RESOURCE_MAX_DESCRIPTORS,
                    &resource_count, device->segment, device->bus,
                    device->device, device->function, device->vendor_id,
                    device->device_id, bar_index, raw_low, raw_high,
                    &firmware_bar, &decoded);
                if (bar_status != GXOS_MANAGED_KERNEL_RESOURCE_OK) continue;
                serial_field_hex("GXOS_NET10:MANAGED_KERNEL_MMIO_BAR_INDEX=0x", bar_index);
                serial_text(" BASE=0x");
                serial_hex64(decoded.base);
                serial_text(" LENGTH=0x");
                serial_hex64(decoded.length);
    ...
    zero_bytes((uint8_t *)&g_managed_kernel_device_resource_publication_storage,
               sizeof(g_managed_kernel_device_resource_publication_storage));
    g_managed_kernel_device_resource_publication =
        &g_managed_kernel_device_resource_publication_storage;
    g_managed_kernel_device_resource_publication->Size =
        GX_MANAGED_KERNEL_DEVICE_RESOURCE_PUBLICATION_V1_SIZE;
    g_managed_kernel_device_resource_publication->AbiVersion =
        GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1;
    g_managed_kernel_device_resource_publication->SummaryAddress =
        (uint64_t)(uintptr_t)&g_managed_kernel_device_resource_summary;
    g_managed_kernel_device_resource_publication->DescriptorAddress =
        (uint64_t)(uintptr_t)g_managed_kernel_device_resources;
    g_managed_kernel_device_resource_publication->DescriptorCount = resource_count;
    g_managed_kernel_device_resource_publication->DescriptorSize =
        GX_MANAGED_KERNEL_DEVICE_RESOURCE_V1_SIZE;
    g_managed_kernel_device_resource_publication->DescriptorByteLength = descriptor_bytes;
    g_managed_kernel_device_resource_snapshot_ready = 1;
    serial_text("GXOS_NET10:MANAGED_KERNEL_RESOURCE_NATIVE_SNAPSHOT_READY\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_RESOURCE_DISCOVERY=PLATFORM_AUTHORITATIVE_IO\r\n");
    serial_field_hex("GXOS_NET10:NATIVE_RESOURCE_COUNT=0x", resource_count);
    serial_text("\r\n");
    for (index = 0; index != resource_count; ++index) {
        serial_field_hex("GXOS_NET10:NATIVE_RESOURCE_ID=0x",
                         g_managed_kernel_device_resources[index].ResourceId);
        serial_text(" BASE=0x");
        serial_hex64(g_managed_kernel_device_resources[index].PhysicalBase);
        serial_text(" LENGTH=0x");
        serial_hex64(g_managed_kernel_device_resources[index].Length);
        serial_text(" TYPE=0x");
        serial_hex64(g_managed_kernel_device_resources[index].ResourceType);
        serial_text(" OWNER_KIND=0x");
        serial_hex64(g_managed_kernel_device_resources[index].OwnerDeviceKind);
        serial_text(" OWNER_ID=0x");
        serial_hex64(g_managed_kernel_device_resources[index].OwnerDeviceId);
        serial_text("\r\n");
    }
}

static void managed_kernel_set_boot_resource_publication(
    GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1 *publication,
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_SUMMARY_V1 *summary,
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 *regions,
    uint32_t count, uint64_t byte_length)
{
    volatile uint8_t *bytes = (volatile uint8_t *)(void *)publication;
    volatile GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1 *target =
        (volatile GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1 *)(void *)publication;
    uint64_t index;
    for (index = 0; index != sizeof(*publication); ++index) bytes[index] = 0;
    target->Size = GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1_SIZE;
    target->AbiVersion = GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1;
    target->SummaryAddress = (uint64_t)(uintptr_t)summary;
    target->DescriptorAddress = (uint64_t)(uintptr_t)regions;
    target->DescriptorCount = count;
    target->DescriptorSize = GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1_SIZE;
    target->DescriptorByteLength = byte_length;
}

static void managed_kernel_phase2_pre_main(
    ManagedKernelInitializeEntry initialize,
    ManagedKernelQuerySystemInfoEntry query_system_info,
    ManagedKernelInstallBootResourcesEntry install_boot_resources,
    ManagedKernelQueryBootResourcesEntry query_boot_resources,
    ManagedKernelQueryMemoryRegionEntry query_memory_region,
    ManagedKernelStartEntry start)
{
    GX_MANAGED_KERNEL_INIT_REQUEST_V1 request = {0};
    GX_MANAGED_KERNEL_SYSTEM_INFO_V1 system_info;
    GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1 *publication =
        g_managed_kernel_boot_resource_publication;
    ...
    if (g_managed_kernel_boot_resource_snapshot_ready == 0 ||
        g_managed_kernel_boot_resource_summary.RegionCount == 0 ||
        publication == 0) {
        fail("managed-kernel-boot-resource-snapshot-state");
    }
    full_count = g_managed_kernel_boot_resource_summary.RegionCount;
    full_bytes = (uint64_t)full_count *
        GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1_SIZE;
    managed_kernel_set_boot_resource_publication(
        publication, &g_managed_kernel_boot_resource_summary,
        g_managed_kernel_boot_resource_regions, full_count, full_bytes);

    fill_bytes((uint8_t *)&system_info, 0xA5, sizeof(system_info));
    zero_bytes((uint8_t *)&summary, sizeof(summary));
    zero_bytes((uint8_t *)&region, sizeof(region));
    status = query_system_info(
        GX_MANAGED_KERNEL_ABI_V1, (uintptr_t)&system_info, sizeof(system_info));
    if (status != GX_MANAGED_NOT_INITIALIZED ||
        system_info.Size != 0xA5A5A5A5U ||
        query_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        (uintptr_t)&summary, sizeof(summary)) != GX_MANAGED_NOT_INITIALIZED ||
        query_memory_region(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1, 0,
                            (uintptr_t)&region, sizeof(region)) !=
            GX_MANAGED_NOT_INITIALIZED ||
        install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_NOT_INITIALIZED) {
        fail("managed-kernel-boot-resource-before-init");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_BOOT_RESOURCE_QUERY_BEFORE_INIT_REJECTED\r\n");

    request.Size = GX_MANAGED_KERNEL_INIT_REQUEST_V1_SIZE;
    request.AbiVersion = GX_MANAGED_KERNEL_ABI_V1;
    request.Architecture = GX_MANAGED_KERNEL_ARCH_X64;
    request.Flags = 0;
    if (initialize(GX_MANAGED_KERNEL_ABI_V1 + 1U, (uintptr_t)&request) !=
            GX_MANAGED_UNSUPPORTED_ABI) {
        fail("managed-kernel-phase2-unsupported-init");
    }
    if (initialize(GX_MANAGED_KERNEL_ABI_V1, 0) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-phase2-null-init");
    }
    request.Size = GX_MANAGED_KERNEL_INIT_REQUEST_V1_SIZE - 1U;
    if (initialize(GX_MANAGED_KERNEL_ABI_V1, (uintptr_t)&request) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-phase2-malformed-init");
    }
    request.Size = GX_MANAGED_KERNEL_INIT_REQUEST_V1_SIZE;
    if (initialize(GX_MANAGED_KERNEL_ABI_V1, (uintptr_t)&request) !=
            GX_MANAGED_OK ||
        initialize(GX_MANAGED_KERNEL_ABI_V1, (uintptr_t)&request) !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-phase2-init");
    }
    ...
    if (start() != GX_MANAGED_INVALID_STATE) {
        fail("managed-kernel-start-before-boot-resources");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_START_BEFORE_PUBLICATION_REJECTED\r\n");

    fill_bytes((uint8_t *)&summary, 0xA5, sizeof(summary));
    fill_bytes((uint8_t *)&region, 0xA5, sizeof(region));
    if (query_boot_resources(
            GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
            (uintptr_t)&summary, sizeof(summary)) != GX_MANAGED_NOT_INITIALIZED ||
        query_memory_region(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1, 0,
                            (uintptr_t)&region, sizeof(region)) !=
            GX_MANAGED_NOT_INITIALIZED ||
        summary.Size != 0xA5A5A5A5U || region.Size != 0xA5A5A5A5U) {
        fail("managed-kernel-boot-resource-before-publication");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_BOOT_RESOURCE_QUERY_BEFORE_PUBLICATION_REJECTED\r\n");

    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1, 0) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-null-publication");
    }
    publication->Size = GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1_SIZE - 1U;
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-size");
    }
    publication->Size = GX_MANAGED_KERNEL_BOOT_RESOURCE_PUBLICATION_V1_SIZE;
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1 + 1U,
                               (uintptr_t)publication) !=
            GX_MANAGED_UNSUPPORTED_ABI) {
        fail("managed-kernel-boot-resource-abi");
    }
    publication->DescriptorByteLength = UINT64_MAX;
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-byte-overflow");
    }
    publication->DescriptorByteLength = full_bytes;
    publication->DescriptorCount = GX_MANAGED_KERNEL_BOOT_RESOURCE_MAX_REGIONS + 1U;
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-count-bound");
    }
    publication->DescriptorCount = 0;
    publication->DescriptorByteLength = 0;
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-zero-count");
    }
    publication->DescriptorCount = full_count;
    publication->DescriptorAddress = UINT64_MAX - 15U;
    publication->DescriptorByteLength = full_bytes;
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-pointer-overflow");
    }
    publication->DescriptorAddress = (uint64_t)(uintptr_t)
        g_managed_kernel_boot_resource_regions;

    bad_summary = g_managed_kernel_boot_resource_summary;
    bad_summary.RegionCount = 1;
    bad_region = g_managed_kernel_boot_resource_regions[0];
    bad_region.BaseAddress = UINT64_MAX - 0x0FU;
    bad_region.Length = 0x100U;
    managed_kernel_set_boot_resource_publication(
        publication, &bad_summary, &bad_region, 1,
        GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1_SIZE);
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-descriptor-overflow");
    }
    bad_region = g_managed_kernel_boot_resource_regions[0];
    bad_region.Length = 0;
    if (install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                               (uintptr_t)publication) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-boot-resource-zero-length");
    }

    managed_kernel_set_boot_resource_publication(
        publication, &g_managed_kernel_boot_resource_summary,
        g_managed_kernel_boot_resource_regions, full_count, full_bytes);
    status = install_boot_resources(GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
                                    (uintptr_t)publication);
    if (status != GX_MANAGED_OK) {
        serial_field_hex("GXOS_NET10:MANAGED_KERNEL_BOOT_RESOURCE_INSTALL_STATUS=0x",
                         status);
        serial_text("\r\n");
        fail("managed-kernel-boot-resource-install");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_BOOT_RESOURCES_INSTALLED\r\n");
}

static void managed_kernel_host_services_make_valid(void)
{
    zero_bytes((uint8_t *)&g_managed_kernel_host_services,
               sizeof(g_managed_kernel_host_services));
    g_managed_kernel_host_services.Size =
        GX_MANAGED_KERNEL_HOST_SERVICES_V1_SIZE;
    g_managed_kernel_host_services.AbiVersion =
        GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1;
    g_managed_kernel_host_services.ServiceVersion =
        GX_MANAGED_KERNEL_HOST_SERVICES_VERSION_V1;
    g_managed_kernel_host_services.Architecture = GX_MANAGED_KERNEL_ARCH_X64;
    g_managed_kernel_host_services.Capabilities =
        GX_MANAGED_HOST_CAPABILITY_ABI |
...
/* One bounded record per acceptance transition. This is deliberately small:
   it proves the UART/controller/queue boundary without polling it in the
   serial log or putting managed execution in the ISR. */
static void managed_kernel_serial_interrupt_checkpoint(const char *stage)
{
    uint64_t flags;
    uint32_t ioapic_low = managed_kernel_ioapic_read(
        GXOS_MANAGED_KERNEL_IOAPIC_SERIAL_IRQ_REGISTER);
    __asm__ volatile ("pushfq\n\tpopq %0" : "=r"(flags));
    serial_text("GXOS_NET10:MANAGED_KERNEL_SERIAL_RX_CHECKPOINT=");
    serial_text(stage);
    serial_text(" IER=0x");
    serial_hex64(serial_in8(0x3F8 + 1));
    serial_text(" IIR=0x");
    serial_hex64(serial_in8(0x3F8 + 2));
    serial_text(" LSR=0x");
    serial_hex64(serial_in8(0x3F8 + 5));
    serial_text(" MCR=0x");
    serial_hex64(serial_in8(0x3F8 + 4));
    serial_text(" FCR_CONFIGURED=0x");
    serial_hex64(g_managed_kernel_serial_phase9_fcr);
    serial_text(" PIC_MASK=0x");
    serial_hex64(serial_in8(0x21));
    serial_text(" IOAPIC_LOW=0x");
    serial_hex64(ioapic_low);
    serial_text(" IF=0x");
    serial_hex64((flags >> 9) & 1U);
    serial_text(" IRQ_COUNT=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.irq_entry_count, __ATOMIC_ACQUIRE));
    serial_text(" SERIAL_ISR_COUNT=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.serial_isr_count, __ATOMIC_ACQUIRE));
    serial_text(" ENQUEUED_COUNT=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.enqueued_count, __ATOMIC_ACQUIRE));
    serial_text(" DRAINED_COUNT=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.drained_count, __ATOMIC_ACQUIRE));
    serial_text(" QUEUE_READ=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.read_index, __ATOMIC_ACQUIRE));
    serial_text(" QUEUE_WRITE=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.write_index, __ATOMIC_ACQUIRE));
    serial_text(" WORK_PENDING=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.work_pending, __ATOMIC_ACQUIRE));
    serial_text(" WAKE_REQUEST_COUNT=0x");
    serial_hex64(__atomic_load_n(
        &g_managed_kernel_interrupt_context.wake_request_count, __ATOMIC_ACQUIRE));
    serial_text(" WORKER_WAKE_COUNT=0x");
    serial_hex64(g_managed_kernel_driver_worker_context.worker_wake_count);
    serial_text(" MANAGED_DISPATCH_COUNT=0x");
    serial_hex64(g_managed_kernel_driver_worker_context.managed_dispatch_count);
    serial_text("\r\n");
}
...
void gxos_managed_kernel_keyboard_irq_capture(void)
{
    gxos_managed_kernel_interrupt_capture_route(
        &g_managed_kernel_interrupt_context, 1U);
}
...
static void managed_kernel_interrupt_install_idt(void)
{
    ...
    if (g_managed_kernel_serial_interrupt_idt_installed == 0) {
        read_idtr(&current);
...
static int managed_kernel_serial_interrupt_disable(void *opaque)
{
    ...
    serial_out8(0x21, (uint8_t)(g_managed_kernel_serial_saved_pic_mask |
...
static int managed_kernel_keyboard_wait_input_clear(void)
{
    uint32_t attempt;
    for (attempt = 0; attempt != 4096U; ++attempt) {
        if ((serial_in8(0x64) & 0x02U) == 0) return 1;
        __asm__ volatile ("pause" : : : "memory");
    }
    return 0;
}

static int managed_kernel_keyboard_interrupt_enable(void *opaque)
{
    uint32_t ioapic_low;
    (void)opaque;
    managed_kernel_interrupt_install_idt();
    g_managed_kernel_keyboard_saved_pic_mask = serial_in8(0x21);
    g_managed_kernel_keyboard_saved_ioapic_high =
        managed_kernel_ioapic_read(
            GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER + 1U);
    g_managed_kernel_keyboard_saved_ioapic_low =
        managed_kernel_ioapic_read(
            GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER);
    ioapic_low = (g_managed_kernel_keyboard_saved_ioapic_low &
                  ~0x000100FFU) | 0x21U;
    managed_kernel_ioapic_write(
        GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER + 1U,
        g_managed_kernel_keyboard_saved_ioapic_high);
    managed_kernel_ioapic_write(
        GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER, ioapic_low);
    g_managed_kernel_keyboard_interrupt_ioapic_enabled = 1;

    /* The native path is the sole controller reader in this harness. Enable
       the keyboard interface, then leave scan-code translation to managed
       code. No arbitrary controller command crosses the managed boundary. */
    if (!managed_kernel_keyboard_wait_input_clear()) return 0;
    serial_out8(0x64, 0xAEU);
    /* The legacy PIC remains on vector base zero in this profile. Keep its
       IRQ1 masked; the IOAPIC route above owns vector 0x21. */
    serial_out8(0x21, (uint8_t)(g_managed_kernel_keyboard_saved_pic_mask | 0x02U));
    g_managed_kernel_keyboard_interrupt_enabled = 1;
    return (serial_in8(0x21) & 0x02U) != 0 &&
           (managed_kernel_ioapic_read(
                GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER) & 0xFFU) ==
               0x21U &&
           (managed_kernel_ioapic_read(
                GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER) &
                0x00010000U) == 0;
...
static int managed_kernel_keyboard_interrupt_disable(void *opaque)
{
    (void)opaque;
    if (managed_kernel_keyboard_wait_input_clear()) {
        serial_out8(0x64, 0xADU);
    }
    serial_out8(0x21, (uint8_t)(g_managed_kernel_keyboard_saved_pic_mask |
                                (g_managed_kernel_serial_interrupt_ioapic_enabled != 0
                                     ? 0x10U : 0U)));
    if (g_managed_kernel_keyboard_interrupt_ioapic_enabled != 0) {
        managed_kernel_ioapic_write(
            GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER + 1U,
            g_managed_kernel_keyboard_saved_ioapic_high);
        managed_kernel_ioapic_write(
...
static int managed_kernel_keyboard_interrupt_source(
    void *opaque, uint8_t *payload_byte, uint32_t *status)
{
    uint8_t controller_status;
    (void)opaque;
    if (payload_byte == 0 || status == 0) return 0;
    controller_status = serial_in8(0x64);
    if ((controller_status & 0x01U) == 0) return 0;
    if ((controller_status & 0x20U) != 0) {
        /* Auxiliary data shares the controller data register. Consume it at
           the single native capture point but never publish it as a key. */
        (void)serial_in8(0x60);
        return 0;
    }
    *payload_byte = serial_in8(0x60);
    *status = GX_MANAGED_KEYBOARD_STATUS_PRESENT |
              GX_MANAGED_KEYBOARD_STATUS_DATA_READY;
    ++g_managed_kernel_keyboard_irq_capture_count;
    return 1;
}

static void managed_kernel_keyboard_interrupt_eoi(void *opaque)
{
    volatile uint32_t *lapic_eoi;
    (void)opaque;
    serial_out8(0x20, 0x20);
...
static uint32_t GX_MANAGED_KERNEL_MS_ABI
managed_kernel_input_subscribe_service(
    uint32_t event_type, uint32_t device_kind, uint32_t device_id,
    uintptr_t token_address, uintptr_t token_capacity)
{
...
static uint32_t GX_MANAGED_KERNEL_MS_ABI
managed_kernel_input_unsubscribe_service(uint64_t subscription_id)
{
...
static uint32_t GX_MANAGED_KERNEL_MS_ABI
managed_kernel_input_drain_service(
    uint32_t requested_abi_version, uintptr_t output_address,
    uint32_t output_capacity, uintptr_t drained_address,
    uintptr_t drained_capacity)
{
...
static uint32_t GX_MANAGED_KERNEL_MS_ABI
managed_kernel_input_query_stats_service(
    uint32_t requested_abi_version, uintptr_t output_address,
    uintptr_t output_capacity)
{
    return gxos_managed_kernel_interrupt_query_stats_v1(
...
static void managed_kernel_interrupt_services_make_valid(void)
{
    ...
    if (!gxos_managed_kernel_interrupt_add_route(
            &g_managed_kernel_interrupt_context, 1U,
            GX_MANAGED_DEVICE_KIND_PLATFORM_KEYBOARD,
            GX_MANAGED_KEYBOARD_DEVICE_ID_I8042,
            GX_MANAGED_INTERRUPT_EVENT_TYPE_KEYBOARD_SCANCODE,
            managed_kernel_keyboard_interrupt_enable,
            managed_kernel_keyboard_interrupt_disable,
            managed_kernel_keyboard_interrupt_source,
            managed_kernel_keyboard_interrupt_eoi,
            0)) {
        fail("managed-kernel-keyboard-route");
    }
    ...
    zero_bytes((uint8_t *)&g_managed_kernel_input_services,
               sizeof(g_managed_kernel_input_services));
    g_managed_kernel_input_services.Size =
        GX_MANAGED_KERNEL_INPUT_SERVICES_V1_SIZE;
    g_managed_kernel_input_services.AbiVersion =
        GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1;
    g_managed_kernel_input_services.ServiceVersion =
        GX_MANAGED_KERNEL_INPUT_SERVICES_VERSION_V1;
    g_managed_kernel_input_services.Architecture = GX_MANAGED_KERNEL_ARCH_X64;
    g_managed_kernel_input_services.Capabilities =
        GX_MANAGED_INTERRUPT_CAPABILITY_SUBSCRIBE |
        GX_MANAGED_INTERRUPT_CAPABILITY_UNSUBSCRIBE |
        GX_MANAGED_INTERRUPT_CAPABILITY_DRAIN |
        GX_MANAGED_INTERRUPT_CAPABILITY_QUERY_STATS;
    g_managed_kernel_input_services.EventRecordSize =
        GX_MANAGED_KERNEL_INTERRUPT_EVENT_V1_SIZE;
    g_managed_kernel_input_services.QueueCapacity =
        GX_MANAGED_KERNEL_INTERRUPT_QUEUE_CAPACITY;
    g_managed_kernel_input_services.MaxDrain =
        GX_MANAGED_KERNEL_INTERRUPT_MAX_DRAIN;
    g_managed_kernel_input_services.SubscribeAddress =
        (uint64_t)(uintptr_t)managed_kernel_input_subscribe_service;
    g_managed_kernel_input_services.UnsubscribeAddress =
        (uint64_t)(uintptr_t)managed_kernel_input_unsubscribe_service;
    g_managed_kernel_input_services.DrainAddress =
        (uint64_t)(uintptr_t)managed_kernel_input_drain_service;
    g_managed_kernel_input_services.QueryStatsAddress =
        (uint64_t)(uintptr_t)managed_kernel_input_query_stats_service;

    zero_bytes((uint8_t *)&g_managed_kernel_keyboard_device,
               sizeof(g_managed_kernel_keyboard_device));
    g_managed_kernel_keyboard_device.Size =
        GX_MANAGED_KERNEL_KEYBOARD_PLATFORM_DEVICE_V1_SIZE;
    g_managed_kernel_keyboard_device.AbiVersion =
        GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1;
    g_managed_kernel_keyboard_device.DeviceKind =
        GX_MANAGED_DEVICE_KIND_PLATFORM_KEYBOARD;
    g_managed_kernel_keyboard_device.DeviceId =
        GX_MANAGED_KEYBOARD_DEVICE_ID_I8042;
    g_managed_kernel_keyboard_device.Capabilities =
        GX_MANAGED_KEYBOARD_CAPABILITY_RAW_SCANCODE |
        GX_MANAGED_KEYBOARD_CAPABILITY_MAKE_BREAK;
    g_managed_kernel_keyboard_device.Irq = GX_MANAGED_KEYBOARD_IRQ_1;
    g_managed_kernel_keyboard_device.ScancodeSet =
        GX_MANAGED_KEYBOARD_SCANCODE_SET_1;

    zero_bytes((uint8_t *)&g_managed_kernel_keyboard_status,
               sizeof(g_managed_kernel_keyboard_status));
    g_managed_kernel_keyboard_status.Size =
        GX_MANAGED_KERNEL_KEYBOARD_STATUS_V1_SIZE;
    g_managed_kernel_keyboard_status.AbiVersion =
        GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1;
    g_managed_kernel_keyboard_status.Status =
        GX_MANAGED_KEYBOARD_STATUS_PRESENT;
    g_managed_kernel_keyboard_status.Capabilities =
        g_managed_kernel_keyboard_device.Capabilities;
...
static void managed_kernel_serial_services_make_valid(void)
{
    zero_bytes((uint8_t *)&g_managed_kernel_serial_context,
               sizeof(g_managed_kernel_serial_context));
    g_managed_kernel_serial_context.device_kind =
        GX_MANAGED_DEVICE_KIND_PLATFORM_SERIAL;
    g_managed_kernel_serial_context.device_id = GX_MANAGED_SERIAL_DEVICE_ID_COM1;
    g_managed_kernel_serial_context.com_index = GX_MANAGED_SERIAL_COM_INDEX_1;
    g_managed_kernel_serial_context.present = 1;
    g_managed_kernel_serial_context.capabilities =
        GX_MANAGED_SERIAL_CAPABILITY_TRANSMIT |
        GX_MANAGED_SERIAL_CAPABILITY_QUERY_STATUS;
    g_managed_kernel_serial_context.max_transmit_bytes =
        GX_MANAGED_KERNEL_SERIAL_MAX_TRANSMIT_BYTES;
    g_managed_kernel_serial_context.tx_poll_limit =
        GX_MANAGED_KERNEL_SERIAL_TX_POLL_LIMIT;
    g_managed_kernel_serial_context.range_is_known =
        managed_kernel_serial_range_is_known;
    g_managed_kernel_serial_context.transmitter_ready =
        managed_kernel_serial_uart_ready;
    g_managed_kernel_serial_context.transmit_byte =
        managed_kernel_serial_uart_transmit;

    zero_bytes((uint8_t *)&g_managed_kernel_serial_device,
               sizeof(g_managed_kernel_serial_device));
    g_managed_kernel_serial_device.Size =
        GX_MANAGED_KERNEL_SERIAL_PLATFORM_DEVICE_V1_SIZE;
    g_managed_kernel_serial_device.AbiVersion =
        GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1;
    g_managed_kernel_serial_device.DeviceKind =
        GX_MANAGED_DEVICE_KIND_PLATFORM_SERIAL;
    g_managed_kernel_serial_device.DeviceId = GX_MANAGED_SERIAL_DEVICE_ID_COM1;
    g_managed_kernel_serial_device.Capabilities =
        g_managed_kernel_serial_context.capabilities;
    g_managed_kernel_serial_device.ComIndex = GX_MANAGED_SERIAL_COM_INDEX_1;

    zero_bytes((uint8_t *)&g_managed_kernel_serial_services,
               sizeof(g_managed_kernel_serial_services));
    g_managed_kernel_serial_services.Size =
        GX_MANAGED_KERNEL_SERIAL_SERVICES_V1_SIZE;
    g_managed_kernel_serial_services.AbiVersion =
        GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1;
    g_managed_kernel_serial_services.ServiceVersion =
        GX_MANAGED_KERNEL_SERIAL_SERVICES_VERSION_V1;
    g_managed_kernel_serial_services.Architecture = GX_MANAGED_KERNEL_ARCH_X64;
    g_managed_kernel_serial_services.Capabilities =
        g_managed_kernel_serial_context.capabilities;
    g_managed_kernel_serial_services.DeviceKind =
        g_managed_kernel_serial_context.device_kind;
    g_managed_kernel_serial_services.DeviceId =
        g_managed_kernel_serial_context.device_id;
    g_managed_kernel_serial_services.ComIndex =
        g_managed_kernel_serial_context.com_index;
    g_managed_kernel_serial_services.MaxTransmitBytes =
        g_managed_kernel_serial_context.max_transmit_bytes;
    g_managed_kernel_serial_services.TransmitAddress =
        (uint64_t)(uintptr_t)managed_kernel_serial_transmit_service;
    g_managed_kernel_serial_services.QueryStatusAddress =
        (uint64_t)(uintptr_t)managed_kernel_serial_status_service;
}
    ...
    ManagedKernelStartEntry start)
{
    ...
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1, 0) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-host-services-null-table");
    }
    candidate.Size = GX_MANAGED_KERNEL_HOST_SERVICES_V1_SIZE - 1U;
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                              (uintptr_t)&candidate) != GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-host-services-small-table");
    }
    candidate = g_managed_kernel_host_services;
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1 + 1U,
                              (uintptr_t)&candidate) != GX_MANAGED_UNSUPPORTED_ABI) {
        fail("managed-kernel-host-services-unsupported-abi");
    }
    candidate.Architecture = 0;
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                              (uintptr_t)&candidate) != GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-host-services-architecture");
    }
    candidate = g_managed_kernel_host_services;
    candidate.Capabilities |= 1ULL << 63;
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                              (uintptr_t)&candidate) != GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-host-services-unknown-capability");
    }
    candidate = g_managed_kernel_host_services;
    candidate.Reserved0 = 1;
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                              (uintptr_t)&candidate) != GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-host-services-reserved");
    }
    candidate = g_managed_kernel_host_services;
    candidate.LogUtf8Address = 0;
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                              (uintptr_t)&candidate) != GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-host-services-null-log");
    }
    if ((g_managed_kernel_host_services.Capabilities &
            GX_MANAGED_HOST_CAPABILITY_MONOTONIC_TIME) != 0) {
        candidate = g_managed_kernel_host_services;
        candidate.MonotonicTimeAddress = 0;
        if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                                  (uintptr_t)&candidate) != GX_MANAGED_INVALID_ARGUMENT) {
            fail("managed-kernel-host-services-null-time");
        }
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_LIFECYCLE_NEGATIVE_TESTS_OK\r\n");

    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                              (uintptr_t)&g_managed_kernel_host_services) !=
            GX_MANAGED_OK) {
        fail("managed-kernel-host-services-install");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_HOST_SERVICES_INSTALLED\r\n");
    if (install_host_services(GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1,
                              (uintptr_t)&g_managed_kernel_host_services) !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-host-services-repeat");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_HOST_SERVICES_REPEAT_REJECTED\r\n");

    if (start() != GX_MANAGED_OK) fail("managed-kernel-start");
    serial_text("GXOS_NET10:MANAGED_KERNEL_START_OK\r\n");
    if (start() != GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-start-repeat");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_START_ONCE_OK\r\n");
    if (g_managed_kernel_host_log_calls !=
            ((g_managed_kernel_host_services.Capabilities &
              GX_MANAGED_HOST_CAPABILITY_MONOTONIC_TIME) != 0 ? 3U : 2U) ||
        g_managed_kernel_host_time_calls !=
            ((g_managed_kernel_host_services.Capabilities &
              GX_MANAGED_HOST_CAPABILITY_MONOTONIC_TIME) != 0 ? 2U : 0U)) {
        fail("managed-kernel-host-callback-count");
    }
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_HOST_LOG_CALLBACK_COUNT=0x",
                     g_managed_kernel_host_log_calls);
    serial_text("\r\n");
...
static int managed_kernel_device_descriptor_equal(
    const GX_MANAGED_KERNEL_DEVICE_V1 *left,
    const GX_MANAGED_KERNEL_DEVICE_V1 *right)
{
    const uint8_t *left_bytes = (const uint8_t *)left;
    const uint8_t *right_bytes = (const uint8_t *)right;
    uint32_t index;
    for (index = 0; index != GX_MANAGED_KERNEL_DEVICE_V1_SIZE; ++index) {
        if (left_bytes[index] != right_bytes[index]) return 0;
    }
    return 1;
}

static void managed_kernel_phase6_inventory(
    ManagedKernelInstallDeviceInventoryEntry install_device_inventory,
    ManagedKernelQueryDeviceInventorySummaryEntry query_summary,
    ManagedKernelQueryDeviceEntry query_device,
    ManagedKernelRunPhase6Entry run_phase6)
{
    GX_MANAGED_KERNEL_DEVICE_INVENTORY_PUBLICATION_V1 bad_publication;
    GX_MANAGED_KERNEL_DEVICE_INVENTORY_SUMMARY_V1 summary = {0};
    GX_MANAGED_KERNEL_DEVICE_INVENTORY_SUMMARY_V1 repeat_summary = {0};
    GX_MANAGED_KERNEL_DEVICE_V1 device = {0};
    GX_MANAGED_KERNEL_DEVICE_V1 repeat_device = {0};
    uint32_t index;
    uint32_t status;
    ...
    if (install_device_inventory == 0 || query_summary == 0 ||
        query_device == 0 || run_phase6 == 0 ||
        g_managed_kernel_device_inventory_snapshot_ready == 0) {
        fail("managed-kernel-device-inventory-precondition");
    }

    fill_bytes((uint8_t *)&summary, 0xA5, sizeof(summary));
    status = query_summary(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
                           (uintptr_t)&summary, sizeof(summary));
    if (status != GX_MANAGED_NOT_INITIALIZED || summary.Size != 0xA5A5A5A5U) {
        fail("managed-kernel-device-query-before-install");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_QUERY_BEFORE_INSTALL_REJECTED\r\n");

    status = install_device_inventory(
        GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1, 0);
    if (status != GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-device-null-install");
    }
    bad_publication = *g_managed_kernel_device_inventory_publication;
    bad_publication.Size = GX_MANAGED_KERNEL_DEVICE_INVENTORY_PUBLICATION_V1_SIZE - 1U;
    if (install_device_inventory(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
                                 (uintptr_t)&bad_publication) !=
        GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-device-small-publication");
    }
    if (install_device_inventory(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1 + 1U,
                                 (uintptr_t)g_managed_kernel_device_inventory_publication) !=
        GX_MANAGED_UNSUPPORTED_ABI) {
        fail("managed-kernel-device-bad-version");
    }
    fill_bytes((uint8_t *)&summary, 0xA5, sizeof(summary));
    if (query_summary(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
                      (uintptr_t)&summary, sizeof(summary)) !=
            GX_MANAGED_NOT_INITIALIZED || summary.DeviceCount != 0xA5A5A5A5U) {
        fail("managed-kernel-device-query-after-failed-install");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_NEGATIVE_INSTALLS_REJECTED\r\n");

    gxos_managed_kernel_memory_set_operational(&g_managed_kernel_memory, 1);

    if (install_device_inventory(
            GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
            (uintptr_t)g_managed_kernel_device_inventory_publication) != GX_MANAGED_OK ||
        install_device_inventory(
            GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
            (uintptr_t)g_managed_kernel_device_inventory_publication) !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-device-install");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_INSTALL_REPEAT_REJECTED\r\n");
    ...
    if (query_summary(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
                      (uintptr_t)&summary, sizeof(summary)) != GX_MANAGED_OK ||
        summary.Size != GX_MANAGED_KERNEL_DEVICE_INVENTORY_SUMMARY_V1_SIZE ||
        summary.AbiVersion != GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1 ||
        summary.ServiceVersion != GX_MANAGED_KERNEL_DEVICE_INVENTORY_SERVICE_VERSION_V1 ||
        summary.Architecture != GX_MANAGED_KERNEL_ARCH_X64 ||
        summary.DeviceCount != g_managed_kernel_device_inventory_summary.DeviceCount ||
        summary.ResourceCount != 0U ||
        ...
        summary.Reserved != 0) {
        fail("managed-kernel-device-summary");
    }
    serial_field_hex("GXOS_NET10:MANAGED_DEVICE_COUNT=0x", summary.DeviceCount);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_RESOURCE_COUNT=0x", summary.ResourceCount);
    serial_text("\r\n");

    for (index = 0; index != summary.DeviceCount; ++index) {
        fill_bytes((uint8_t *)&device, 0xA5, sizeof(device));
        if (query_device(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1, index,
                         (uintptr_t)&device, sizeof(device)) != GX_MANAGED_OK ||
            !managed_kernel_device_descriptor_equal(
                &device, &g_managed_kernel_device_descriptors[index])) {
            fail("managed-kernel-device-descriptor-match");
        }
    }
    if (query_device(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
                     summary.DeviceCount, (uintptr_t)&device, sizeof(device)) !=
            GX_MANAGED_OUT_OF_RANGE ||
        query_device(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1 + 1U, 0,
                     (uintptr_t)&device, sizeof(device)) != GX_MANAGED_UNSUPPORTED_ABI ||
        query_device(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1, 0, 0,
                     sizeof(device)) != GX_MANAGED_INVALID_ARGUMENT ||
        query_device(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1, 0,
                     (uintptr_t)&device, sizeof(device) - 1U) !=
                     GX_MANAGED_BUFFER_TOO_SMALL) {
        fail("managed-kernel-device-query-negative");
    }
    if (query_device(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1, 0,
                     (uintptr_t)&repeat_device, sizeof(repeat_device)) !=
            GX_MANAGED_OK ||
        !managed_kernel_device_descriptor_equal(
            &repeat_device, &g_managed_kernel_device_descriptors[0]) ||
        query_summary(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
                      (uintptr_t)&repeat_summary, sizeof(repeat_summary)) !=
            GX_MANAGED_OK ||
        repeat_summary.DeviceCount != summary.DeviceCount ||
        repeat_summary.ResourceCount != summary.ResourceCount) {
        fail("managed-kernel-device-repeat-query");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_QUERY_MATCH_OK\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_RESOURCE_DATA_UNAVAILABLE\r\n");
    ...
    if (status != GX_MANAGED_OK ||
        ...
        fail("managed-kernel-device-accounting-restore");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_DEVICE_ACCOUNTING_RESTORED\r\n");
    if (query_summary(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1,
                      (uintptr_t)&repeat_summary, sizeof(repeat_summary)) !=
            GX_MANAGED_OK || repeat_summary.DeviceCount != summary.DeviceCount ||
        query_device(GX_MANAGED_KERNEL_DEVICE_INVENTORY_ABI_V1, 0,
                     (uintptr_t)&repeat_device, sizeof(repeat_device)) != GX_MANAGED_OK ||
        !managed_kernel_device_descriptor_equal(
            &repeat_device, &g_managed_kernel_device_descriptors[0])) {
        fail("managed-kernel-device-operational-survival");
    }
...
static int managed_kernel_resource_descriptor_equal(
    ...
    const GX_MANAGED_KERNEL_DEVICE_RESOURCE_V1 *right)
{
    ...
    const uint8_t *right_bytes = (const uint8_t *)right;
    uint32_t index;
    for (index = 0; index != GX_MANAGED_KERNEL_DEVICE_RESOURCE_V1_SIZE; ++index) {
        if (left_bytes[index] != right_bytes[index]) return 0;
    }
    return 1;
}

static void managed_kernel_phase12_resources(
    ManagedKernelInstallDeviceResourcesEntry install_resources,
    ManagedKernelQueryDeviceResourceSummaryEntry query_summary,
    ManagedKernelQueryDeviceResourceEntry query_resource,
    ManagedKernelRunPhase12Entry run_phase12)
{
    GX_MANAGED_KERNEL_DEVICE_RESOURCE_SUMMARY_V1 summary = {0};
    GX_MANAGED_KERNEL_DEVICE_RESOURCE_SUMMARY_V1 repeat_summary = {0};
    GX_MANAGED_KERNEL_DEVICE_RESOURCE_V1 resource = {0};
    GX_MANAGED_KERNEL_DEVICE_RESOURCE_V1 repeat_resource = {0};
    GX_MANAGED_KERNEL_DEVICE_RESOURCE_PUBLICATION_V1 bad_publication;
    uint32_t status;
    uint32_t index;

    if (install_resources == 0 || query_summary == 0 || query_resource == 0 ||
        run_phase12 == 0 || g_managed_kernel_device_resource_snapshot_ready == 0) {
        fail("managed-kernel-resource-precondition");
    }
    fill_bytes((uint8_t *)&summary, 0xA5, sizeof(summary));
    status = query_summary(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1,
                           (uintptr_t)&summary, sizeof(summary));
    if (status != GX_MANAGED_NOT_INITIALIZED || summary.Size != 0xA5A5A5A5U) {
        fail("managed-kernel-resource-query-before-install");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_RESOURCE_QUERY_BEFORE_INSTALL_REJECTED\r\n");
    if (install_resources(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1, 0) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-resource-null-install");
    }
    bad_publication = *g_managed_kernel_device_resource_publication;
    bad_publication.Size = GX_MANAGED_KERNEL_DEVICE_RESOURCE_PUBLICATION_V1_SIZE - 1U;
    if (install_resources(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1,
                          (uintptr_t)&bad_publication) != GX_MANAGED_INVALID_ARGUMENT ||
        install_resources(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1 + 1U,
                          (uintptr_t)g_managed_kernel_device_resource_publication) !=
            GX_MANAGED_UNSUPPORTED_ABI) {
        fail("managed-kernel-resource-negative-install");
    }
    if (install_resources(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1,
                          (uintptr_t)g_managed_kernel_device_resource_publication) !=
            GX_MANAGED_OK ||
        install_resources(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1,
                          (uintptr_t)g_managed_kernel_device_resource_publication) !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-resource-install");
    }
    if (query_summary(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1,
                      (uintptr_t)&summary, sizeof(summary)) != GX_MANAGED_OK ||
        summary.Size != GX_MANAGED_KERNEL_DEVICE_RESOURCE_SUMMARY_V1_SIZE ||
        summary.ResourceCount < 3U ||
        summary.ResourceCount > GX_MANAGED_KERNEL_DEVICE_RESOURCE_MAX_DESCRIPTORS ||
        summary.MaxClaims !=
            GX_MANAGED_KERNEL_DEVICE_RESOURCE_MAX_CLAIMS ||
        summary.Capabilities !=
            (GX_MANAGED_DEVICE_RESOURCE_CAPABILITY_SUMMARY |
        ...
        fail("managed-kernel-resource-summary");
    }
    for (index = 0; index != summary.ResourceCount; ++index) {
        fill_bytes((uint8_t *)&resource, 0, sizeof(resource));
        if (query_resource(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1, index,
                           (uintptr_t)&resource, sizeof(resource)) != GX_MANAGED_OK ||
            !managed_kernel_resource_descriptor_equal(
                &resource, &g_managed_kernel_device_resources[index])) {
            fail("managed-kernel-resource-descriptor-match");
        }
    }
    fill_bytes((uint8_t *)&repeat_summary, 0xA5, sizeof(repeat_summary));
    fill_bytes((uint8_t *)&repeat_resource, 0xA5, sizeof(repeat_resource));
    if (query_summary(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1,
                      (uintptr_t)&repeat_summary, sizeof(repeat_summary)) != GX_MANAGED_OK ||
        query_resource(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1, summary.ResourceCount,
                       (uintptr_t)&repeat_resource, sizeof(repeat_resource)) != GX_MANAGED_OUT_OF_RANGE ||
        query_resource(GX_MANAGED_KERNEL_DEVICE_RESOURCES_ABI_V1 + 1U, 0,
                       (uintptr_t)&repeat_resource, sizeof(repeat_resource)) != GX_MANAGED_UNSUPPORTED_ABI ||
        repeat_summary.ResourceCount != summary.ResourceCount ||
        repeat_resource.Size != 0xA5A5A5A5U) {
        fail("managed-kernel-resource-negative-query");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_RESOURCE_DESCRIPTOR_MATCH\r\n");
    if (run_phase12(1U) != GX_MANAGED_OK ||
        run_phase12(1U) != GX_MANAGED_INVALID_STATE) {
        fail("managed-kernel-resource-phase-proof");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_RESOURCE_PHASE_PROOF_OK\r\n");
}

static void managed_kernel_phase13_mmio(
    ManagedKernelInstallMmioServicesEntry install_mmio_services,
    ManagedKernelRunPhase13Entry run_phase13)
{
    uint32_t status;
    if (install_mmio_services == 0 || run_phase13 == 0) {
        fail("managed-kernel-mmio-precondition");
    }
    if (g_managed_kernel_mmio_service_ready == 0) {
        serial_text("GXOS_NET10:MANAGED_KERNEL_PHASE13_BLOCKED=MMIO_SERVICE_NOT_READY\r\n");
        return;
    }
    if (install_mmio_services(GX_MANAGED_KERNEL_MMIO_SERVICES_ABI_V1, 0) !=
            GX_MANAGED_INVALID_ARGUMENT ||
        install_mmio_services(GX_MANAGED_KERNEL_MMIO_SERVICES_ABI_V1 + 1U,
                              (uintptr_t)&g_managed_kernel_mmio_services) !=
            GX_MANAGED_UNSUPPORTED_ABI ||
        install_mmio_services(GX_MANAGED_KERNEL_MMIO_SERVICES_ABI_V1,
                              (uintptr_t)&g_managed_kernel_mmio_services) !=
            GX_MANAGED_OK ||
        install_mmio_services(GX_MANAGED_KERNEL_MMIO_SERVICES_ABI_V1,
                              (uintptr_t)&g_managed_kernel_mmio_services) !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-mmio-install");
    }
    status = run_phase13(1U);
    if (status == GX_MANAGED_NOT_FOUND || status == GX_MANAGED_INVALID_STATE ||
        status == GX_MANAGED_RESOURCE_EXHAUSTED ||
        status == GX_MANAGED_UNSUPPORTED_ABI) {
        serial_field_hex("GXOS_NET10:MANAGED_KERNEL_PHASE13_BLOCKED_STATUS=0x",
                         status);
        serial_text("\r\n");
        return;
    }
    if (status != GX_MANAGED_OK || run_phase13(1U) != GX_MANAGED_INVALID_STATE ||
        run_phase13(2U) != GX_MANAGED_OK ||
        run_phase13(2U) != GX_MANAGED_INVALID_STATE) {
        fail("managed-kernel-mmio-phase-proof");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_MMIO_PHASE_PROOF_OK\r\n");
}
...
static void managed_kernel_phase8_serial(
    ManagedKernelInstallSerialServicesEntry install_serial_services,
    ManagedKernelRunPhase8AccountingEntry run_accounting,
    ManagedKernelRunPhase8Entry run_phase8)
{
    GX_MANAGED_KERNEL_SERIAL_SERVICES_V1 bad_services;
    GX_MANAGED_KERNEL_SERIAL_PLATFORM_DEVICE_V1 bad_device;
    uint32_t baseline_live;
    uint64_t baseline_physical;
    uint64_t baseline_commit;
    uint64_t baseline_virtual;
    ...
    if (install_serial_services == 0 || run_accounting == 0 ||
        run_phase8 == 0 || g_managed_kernel_memory_service_installed == 0 ||
        !gxos_managed_kernel_memory_validate(&g_managed_kernel_memory)) {
        fail("managed-kernel-serial-precondition");
    }
    managed_kernel_serial_services_make_valid();
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                0, (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_INVALID_ARGUMENT ||
        install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1 + 1U,
                                (uintptr_t)&g_managed_kernel_serial_services,
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_UNSUPPORTED_ABI) {
        fail("managed-kernel-serial-install-negative-null-or-version");
    }
    bad_services = g_managed_kernel_serial_services;
    bad_services.Size--;
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                (uintptr_t)&bad_services,
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-serial-small-service");
    }
    bad_services = g_managed_kernel_serial_services;
    bad_services.Architecture = 0;
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                (uintptr_t)&bad_services,
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-serial-architecture");
    }
    bad_services = g_managed_kernel_serial_services;
    ...
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                ...
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-serial-capability");
    }
    bad_services = g_managed_kernel_serial_services;
    bad_services.TransmitAddress = 0;
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                (uintptr_t)&bad_services,
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-serial-null-transmit");
    }
    bad_services = g_managed_kernel_serial_services;
    bad_services.Reserved0 = 1;
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                ...
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-serial-reserved");
    }
    bad_services = g_managed_kernel_serial_services;
    bad_services.DeviceId++;
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                (uintptr_t)&bad_services,
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-serial-device-identity");
    }
    bad_device = g_managed_kernel_serial_device;
    bad_device.DeviceKind = GX_MANAGED_DEVICE_KIND_PCI;
    if (install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                (uintptr_t)&g_managed_kernel_serial_services,
                                (uintptr_t)&bad_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-serial-platform-kind");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_SERIAL_NATIVE_NEGATIVE_TESTS_OK\r\n");
    ...
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_BASELINE_COMMIT=0x", baseline_commit);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_BASELINE_VIRTUAL=0x", baseline_virtual);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_BASELINE_RESERVATIONS=0x", baseline_reservations);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_BASELINE_COMMITMENTS=0x", baseline_commitments);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_BASELINE_RESERVED=0x", baseline_reserved);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_BASELINE_COMMITTED=0x", baseline_committed);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_BASELINE_REGIONS=0x", baseline_regions);
    serial_text("\r\n");

    status = install_serial_services(
        GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
        (uintptr_t)&g_managed_kernel_serial_services,
        (uintptr_t)&g_managed_kernel_serial_device);
    if (status != GX_MANAGED_OK ||
        install_serial_services(GX_MANAGED_KERNEL_SERIAL_SERVICES_ABI_V1,
                                (uintptr_t)&g_managed_kernel_serial_services,
                                (uintptr_t)&g_managed_kernel_serial_device) !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-serial-service-install");
    }
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_CAPABILITIES=0x",
                     g_managed_kernel_serial_services.Capabilities);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_MAX_TX=0x",
                     g_managed_kernel_serial_services.MaxTransmitBytes);
    serial_text("\r\n");

    if (run_accounting() != GX_MANAGED_OK ||
        g_memory_ledger.live_count != baseline_live ||
        g_memory_ledger.physical_bytes != baseline_physical ||
        g_memory_ledger.commit_bytes != baseline_commit ||
        g_memory_ledger.virtual_reservation_bytes != baseline_virtual ||
        ...
        g_memory_virtual_arena.total_committed_bytes != baseline_committed ||
        g_memory_vm_regions.live_count != baseline_regions ||
        g_managed_kernel_serial_context.successful_transmit_count != 0U ||
        !gxos_managed_kernel_memory_validate(&g_managed_kernel_memory)) {
        fail("managed-kernel-serial-accounting-restore");
    }
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_LIVE=0x", g_memory_ledger.live_count);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_PHYSICAL=0x", g_memory_ledger.physical_bytes);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_COMMIT=0x", g_memory_ledger.commit_bytes);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_VIRTUAL=0x", g_memory_ledger.virtual_reservation_bytes);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_RESERVATIONS=0x", g_memory_virtual_arena.reservation_count);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_COMMITMENTS=0x", g_memory_virtual_arena.commitment_count);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_RESERVED=0x", g_memory_virtual_arena.total_reserved_bytes);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_COMMITTED=0x", g_memory_virtual_arena.total_committed_bytes);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_SERIAL_ACCOUNTING_AFTER_REGIONS=0x", g_memory_vm_regions.live_count);
    serial_text("\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_SERIAL_NATIVE_ACCOUNTING_OK\r\n");

    if (run_phase8() != GX_MANAGED_OK ||
        g_managed_kernel_serial_context.successful_transmit_count != 2U) {
        fail("managed-kernel-serial-driver-run");
    }
...
static int managed_kernel_interrupt_worker_rearmed(
    GXOS_MANAGED_KERNEL_DRIVER_WORKER_CONTEXT *worker)
{
    GXOS_SCHEDULER_EVENT *event;
    GXOS_SCHEDULER_TCB *thread;
    uint32_t ioapic_low;
    uint32_t keyboard_ioapic_low;
    if (worker == 0 || worker->thread == 0 || worker->wake_event == 0 ||
        worker->state != GXOS_MANAGED_KERNEL_DRIVER_WORKER_RUNNING ||
        __atomic_load_n(&g_managed_kernel_interrupt_context.subscription_active,
                        __ATOMIC_ACQUIRE) == 0 ||
        __atomic_load_n(&g_managed_kernel_interrupt_context.hardware_enabled,
                        __ATOMIC_ACQUIRE) == 0 ||
        __atomic_load_n(&g_managed_kernel_interrupt_context.read_index,
                        __ATOMIC_ACQUIRE) !=
            __atomic_load_n(&g_managed_kernel_interrupt_context.write_index,
                            __ATOMIC_ACQUIRE) ||
        __atomic_load_n(&g_managed_kernel_interrupt_context.work_pending,
                        __ATOMIC_ACQUIRE) != 0) {
        return 0;
    }
    event = gxos_scheduler_event_from_handle(worker->wake_event);
    thread = worker->thread;
    ioapic_low = managed_kernel_ioapic_read(
        GXOS_MANAGED_KERNEL_IOAPIC_SERIAL_IRQ_REGISTER);
    keyboard_ioapic_low = managed_kernel_ioapic_read(
        GXOS_MANAGED_KERNEL_IOAPIC_KEYBOARD_IRQ_REGISTER);
    return (serial_in8(0x3F8 + 1) & 0x01U) != 0 &&
           (serial_in8(0x3F8 + 4) & 0x08U) != 0 &&
           (serial_in8(0x21) & 0x10U) != 0 &&
           (ioapic_low & 0xFFU) == 0x24U &&
           (ioapic_low & 0x00010000U) == 0 &&
           (ioapic_low & 0x00008000U) == 0 &&
           (g_managed_kernel_interrupt_context.route_count < 2U ||
            (g_managed_kernel_interrupt_context.routes[1].subscription_active == 0 ||
             (g_managed_kernel_keyboard_interrupt_enabled != 0 &&
              (serial_in8(0x21) & 0x02U) != 0 &&
              (keyboard_ioapic_low & 0xFFU) == 0x21U &&
              (keyboard_ioapic_low & 0x00010000U) == 0 &&
              (keyboard_ioapic_low & 0x00008000U) == 0))) &&
           thread->live != 0 &&
           thread->state == GXOS_SCHEDULER_THREAD_BLOCKED &&
           event != 0 && event->live != 0 && event->manual_reset == 0 &&
    ...
    ManagedKernelRunPhase11Entry run_phase11)
{
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL_PHASE11
    GX_MANAGED_KERNEL_INPUT_SERVICES_V1 bad_input_services;
    GX_MANAGED_KERNEL_KEYBOARD_PLATFORM_DEVICE_V1 bad_keyboard_device;
#endif
    ...
    if (install_input_services(GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1, 0,
            ...
            GX_MANAGED_INVALID_ARGUMENT ||
        install_input_services(GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1 + 1U,
                               (uintptr_t)&g_managed_kernel_input_services,
                               (uintptr_t)&g_managed_kernel_keyboard_device) !=
            GX_MANAGED_UNSUPPORTED_ABI) {
        fail("managed-kernel-input-install-negative-null-or-version");
    }
    bad_input_services = g_managed_kernel_input_services;
    bad_input_services.Size--;
    if (install_input_services(GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1,
                               (uintptr_t)&bad_input_services,
                               (uintptr_t)&g_managed_kernel_keyboard_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-input-install-negative-size");
    }
    bad_input_services = g_managed_kernel_input_services;
    bad_input_services.Reserved1 = 1;
    if (install_input_services(GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1,
                               (uintptr_t)&bad_input_services,
                               (uintptr_t)&g_managed_kernel_keyboard_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-input-install-negative-reserved");
    }
    bad_keyboard_device = g_managed_kernel_keyboard_device;
    bad_keyboard_device.DeviceId++;
    if (install_input_services(GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1,
                               (uintptr_t)&g_managed_kernel_input_services,
                               (uintptr_t)&bad_keyboard_device) !=
            GX_MANAGED_INVALID_ARGUMENT) {
        fail("managed-kernel-input-install-negative-device");
    }
    if (install_input_services(GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1,
                               (uintptr_t)&g_managed_kernel_input_services,
                               (uintptr_t)&g_managed_kernel_keyboard_device) !=
            GX_MANAGED_OK ||
        install_input_services(GX_MANAGED_KERNEL_INPUT_SERVICES_ABI_V1,
                               (uintptr_t)&g_managed_kernel_input_services,
                               (uintptr_t)&g_managed_kernel_keyboard_device) !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        fail("managed-kernel-input-service-install");
    }
    ...
    managed_kernel_interrupt_enable_cpu();
    managed_kernel_serial_interrupt_checkpoint("BEFORE_FIRST");
    serial_text("GXOS_NET10:MANAGED_KERNEL_SERIAL_RX_WORKER_UART_READY\r\n");
    managed_kernel_interrupt_enable_cpu();
    if (!managed_kernel_interrupt_wait_for_enqueued(
            boot_services, &g_managed_kernel_driver_worker_context, 1)) {
        managed_kernel_serial_interrupt_checkpoint("FIRST_TIMEOUT");
        fail("managed-kernel-serial-rx-timeout-first");
    }
    managed_kernel_serial_interrupt_checkpoint("AFTER_FIRST");
    ...
    if (run_phase11(1) != GX_MANAGED_OK) {
        restore_nativeaot_tls();
        fail("managed-kernel-keyboard-bind");
    }
    restore_nativeaot_tls();
    managed_kernel_interrupt_enable_cpu();
    if (!managed_kernel_interrupt_wait_for_worker_rearmed(
            boot_services, &g_managed_kernel_driver_worker_context)) {
        fail("managed-kernel-keyboard-ready-invariant");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_INPUT_READY\r\n");
    if (!managed_kernel_interrupt_wait_for_enqueued(
            boot_services, &g_managed_kernel_driver_worker_context, 3U)) {
        fail("managed-kernel-keyboard-timeout-first");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_IRQ_CAPTURED\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_EVENT_ENQUEUED\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_EVENT_DRAINED\r\n");
    activate_nativeaot_tls();
    if (run_phase11(3) != GX_MANAGED_OK) {
        restore_nativeaot_tls();
        fail("managed-kernel-keyboard-runtime");
    }
    restore_nativeaot_tls();
    if (!managed_kernel_interrupt_wait_for_worker_rearmed(
            boot_services, &g_managed_kernel_driver_worker_context)) {
        fail("managed-kernel-keyboard-second-ready-invariant");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_SECOND_INPUT_READY\r\n");
    if (!managed_kernel_interrupt_wait_for_enqueued(
            boot_services, &g_managed_kernel_driver_worker_context, 6U)) {
        fail("managed-kernel-keyboard-timeout-second");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_IRQ_CAPTURED\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_EVENT_ENQUEUED\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_EVENT_DRAINED\r\n");
    {
        uint64_t keyboard_capture_before = g_managed_kernel_keyboard_irq_capture_count;
        activate_nativeaot_tls();
        if (run_phase11(4) != GX_MANAGED_OK) {
            restore_nativeaot_tls();
            fail("managed-kernel-keyboard-unsubscribe");
        }
        restore_nativeaot_tls();
        if (g_managed_kernel_interrupt_context.routes[1].subscription_active != 0 ||
            g_managed_kernel_interrupt_context.routes[1].hardware_enabled != 0 ||
            g_managed_kernel_keyboard_interrupt_enabled != 0 ||
            g_managed_kernel_interrupt_context.routes[0].subscription_active == 0 ||
            g_managed_kernel_interrupt_context.routes[0].hardware_enabled == 0) {
            fail("managed-kernel-keyboard-unsubscribe-state");
        }
        serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_UNSUBSCRIBED_READY\r\n");
        if (boot_services->Stall != 0 && EFI_ERROR(boot_services->Stall(1000000))) {
            fail("managed-kernel-keyboard-post-unsubscribe-stall");
        }
        if (g_managed_kernel_keyboard_irq_capture_count != keyboard_capture_before) {
            fail("managed-kernel-keyboard-post-unsubscribe-delivery");
        }
        serial_text("GXOS_NET10:MANAGED_KERNEL_KEYBOARD_NO_DELIVERY_AFTER_UNSUBSCRIBE_OK\r\n");
        serial_text("GXOS_NET10:MANAGED_KERNEL_MULTI_DRIVER_ROUTING_OK\r\n");
    }
#endif
    ...
    /* Managed dispatch and the required burst may legitimately retain new
       NativeAOT heap pages. Establish the teardown comparison after all
       managed activity, immediately before unsubscribe, so only worker,
       subscription, and native arena cleanup are measured below. */
    baseline_live = g_memory_ledger.live_count;
    baseline_physical = g_memory_ledger.physical_bytes;
    baseline_commit = g_memory_ledger.commit_bytes;
    baseline_virtual = g_memory_ledger.virtual_reservation_bytes;
    ...
    baseline_regions = g_memory_vm_regions.live_count;
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_LIVE=0x",
        baseline_live);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_PHYSICAL=0x",
        baseline_physical);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_COMMIT=0x",
        baseline_commit);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_VIRTUAL=0x",
        baseline_virtual);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_RESERVATIONS=0x",
        baseline_reservations);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_COMMITMENTS=0x",
        baseline_commitments);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_RESERVED=0x",
        baseline_reserved);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_COMMITTED=0x",
        baseline_committed);
    serial_text("\r\n");
    serial_field_hex(
        "GXOS_NET10:MANAGED_KERNEL_INTERRUPT_TEARDOWN_FINAL_BASELINE_REGIONS=0x",
        baseline_regions);
    serial_text("\r\n");
    ...
    if (stats.IrqEntryCount <
        ...
        g_memory_ledger.virtual_reservation_bytes !=
            baseline_virtual - driver_arena_virtual_bytes ||
        g_memory_virtual_arena.reservation_count !=
            baseline_reservations - driver_arena_reservations ||
        g_memory_virtual_arena.commitment_count !=
            baseline_commitments - driver_arena_commitments ||
    ...
    serial_text("GXOS_NET10:MANAGED_KERNEL_PHASE11_PASS\r\n");
#endif
    ...
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_SUMMARY_V1 *summary)
{
    return summary != 0 &&
           ...
           summary->ServiceVersion ==
               GX_MANAGED_KERNEL_BOOT_RESOURCES_SERVICE_VERSION_V1 &&
           summary->Architecture == GX_MANAGED_KERNEL_ARCH_X64 &&
           summary->RegionCount == g_memory_map.descriptor_count &&
           summary->RegionCount == g_memory_classification.descriptor_count &&
           summary->ResourceMapIdentity ==
               GX_MANAGED_KERNEL_BOOT_RESOURCE_MAP_ID_UEFI_NORMALIZED_V1 &&
           summary->TotalPhysicalBytes ==
               g_memory_classification.total_ram_like_bytes &&
           summary->UsablePhysicalBytes ==
               g_memory_classification.conventional_bytes &&
           summary->Capabilities ==
...
static int managed_kernel_region_matches_authority(
    uint32_t index,
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 *region)
{
    const EFI_MEMORY_DESCRIPTOR *descriptor;
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 *expected;
    GXOS_MEMORY_CLASS memory_class;
    uint64_t length;
    if (region == 0 || index >= g_memory_map.descriptor_count ||
        index >= g_managed_kernel_boot_resource_summary.RegionCount) {
        return 0;
    }
    descriptor = gxos_uefi_memory_map_descriptor(&g_memory_map, index);
    expected = &g_managed_kernel_boot_resource_regions[index];
    if (descriptor == 0 || descriptor->NumberOfPages == 0 ||
        descriptor->NumberOfPages > UINT64_MAX / GXOS_MEMORY_PAGE_SIZE) {
        return 0;
    }
    length = descriptor->NumberOfPages * GXOS_MEMORY_PAGE_SIZE;
    memory_class = gxos_memory_class_for_efi_type(descriptor->Type);
    return region->Size == expected->Size &&
           region->AbiVersion == expected->AbiVersion &&
           region->BaseAddress == descriptor->PhysicalStart &&
           region->Length == length &&
           region->Type == (uint32_t)memory_class + 1U &&
           region->Flags == expected->Flags;
}

static int managed_kernel_region_equal(
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 *left,
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 *right)
{
    return left != 0 && right != 0 && left->Size == right->Size &&
           left->AbiVersion == right->AbiVersion &&
           left->BaseAddress == right->BaseAddress &&
           left->Length == right->Length && left->Type == right->Type &&
           left->Flags == right->Flags;
}

static void managed_kernel_emit_region_evidence(
    const char *label, uint32_t index,
    const GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 *region)
{
    serial_text("GXOS_NET10:");
    serial_text(label);
    serial_text("_INDEX=0x");
    serial_hex64(index);
    serial_text("\r\n");
    serial_text("GXOS_NET10:");
    serial_text(label);
    serial_text("_BASE=0x");
    serial_hex64(region->BaseAddress);
    serial_text("\r\n");
    serial_text("GXOS_NET10:");
    serial_text(label);
    serial_text("_LENGTH=0x");
    serial_hex64(region->Length);
    serial_text("\r\n");
    serial_text("GXOS_NET10:");
    serial_text(label);
    serial_text("_TYPE=0x");
    serial_hex64(region->Type);
    serial_text("\r\n");
    serial_text("GXOS_NET10:");
    serial_text(label);
    serial_text("_FLAGS=0x");
    serial_hex64(region->Flags);
    serial_text("\r\n");
}
#endif
    ...
    GXOS_PROCESS_GROUP_AFFINITY_USHORT *group_array)
{
    ...
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:GETPROCESSGROUPAFFINITY_IAT_RVA=0x",
                     GXOS_NATIVEAOT_IAT_RVA(0x7D2A0));
    serial_text("\r\n");
    ...
    serial_field_hex("GXOS_NET10:GETPROCESSGROUPAFFINITY_IAT_RUNTIME_ADDRESS=0x",
                     g_managed_image_base + GXOS_NATIVEAOT_IAT_RVA(0x7D2A0ULL));
    serial_text("\r\n");
    ...
    GXOS_QUERY_JOB_REPORT *report)
{
    ...
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:QUERYJOBOBJECT_IAT_RVA=0x",
                     GXOS_NATIVEAOT_IAT_RVA(0x7D1F0));
    serial_text("\r\n");
    ...
    serial_field_hex("GXOS_NET10:QUERYJOBOBJECT_RUNTIME_IAT=0x",
                     g_managed_image_base + GXOS_NATIVEAOT_IAT_RVA(0x7D1F0ULL));
    serial_text("\r\n");
    ...
    GXOS_PROCESS_AFFINITY_DWORD_PTR *system_affinity_mask)
{
    ...
    serial_field_hex("GXOS_NET10:GETPROCESSAFFINITYMASK_IAT_RVA=0x",
                     GXOS_NATIVEAOT_IAT_RVA(0x7d208U));
    serial_text("\r\n");
    ...
    serial_field_hex("GXOS_NET10:GETPROCESSAFFINITYMASK_RUNTIME_IAT=0x",
                     g_managed_image_base + GXOS_NATIVEAOT_IAT_RVA(0x7d208U));
    serial_text("\r\n");
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
static void find_managed_gc_probe(PE_IMAGE *image)
{
    GXOS_NATIVEAOT_EXPORT_IMAGE export_image = {
        image->loaded, image->loaded_size, image->export_rva,
        image->export_size};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION resolution = {0};
    GXOS_NATIVEAOT_EXPORT_STATUS status = gxos_nativeaot_find_export(
        &export_image, "ManagedGcProbe", &resolution);
    if (status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("ManagedGcProbe-export-missing");
    }
    image->managed_gc_probe_rva = resolution.rva;
}
#endif
...
static void find_managed_kernel_exports(PE_IMAGE *image)
{
    ...
    GXOS_NATIVEAOT_EXPORT_RESOLUTION query_device_resolution = {0};
    ...
    GXOS_NATIVEAOT_EXPORT_RESOLUTION install_input_services_resolution = {0};
    ...
    GXOS_NATIVEAOT_EXPORT_RESOLUTION run_phase11_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION install_device_resources_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION query_device_resource_summary_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION query_device_resource_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION run_phase12_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION install_mmio_services_resolution = {0};
    ...
    GXOS_NATIVEAOT_EXPORT_STATUS query_status =
        gxos_nativeaot_find_export(&export_image,
                                   ...
                                   &query_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS install_status =
        gxos_nativeaot_find_export(&export_image,
    ...
    GXOS_NATIVEAOT_EXPORT_STATUS boot_resources_status =
        gxos_nativeaot_find_export(&export_image,
                                   ...
                                   &boot_resources_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS memory_region_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedQueryMemoryRegion",
                                   &memory_region_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS install_host_services_status =
        gxos_nativeaot_find_export(&export_image,
    ...
    GXOS_NATIVEAOT_EXPORT_STATUS install_device_inventory_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedKernelInstallDeviceInventory",
                                   &install_device_inventory_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS query_device_inventory_summary_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedQueryDeviceInventorySummary",
                                   &query_device_inventory_summary_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS query_device_status =
        gxos_nativeaot_find_export(&export_image, "GxManagedQueryDevice",
                                   &query_device_resolution);
    ...
    GXOS_NATIVEAOT_EXPORT_STATUS install_serial_services_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedKernelInstallSerialServices",
                                   &install_serial_services_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS run_phase8_accounting_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedKernelRunPhase8Accounting",
                                   &run_phase8_accounting_resolution);
    ...
    GXOS_NATIVEAOT_EXPORT_STATUS install_input_services_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedKernelInstallInputServices",
                                   &install_input_services_resolution);
    ...
    GXOS_NATIVEAOT_EXPORT_STATUS run_phase11_status =
        gxos_nativeaot_find_export(&export_image, "GxManagedKernelRunPhase11",
                                    &run_phase11_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS install_device_resources_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedKernelInstallDeviceResources",
                                   &install_device_resources_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS query_device_resource_summary_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedQueryDeviceResourceSummary",
                                   &query_device_resource_summary_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS query_device_resource_status =
        gxos_nativeaot_find_export(&export_image, "GxManagedQueryDeviceResource",
                                   &query_device_resource_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS run_phase12_status =
        gxos_nativeaot_find_export(&export_image, "GxManagedKernelRunPhase12",
                                   &run_phase12_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS install_mmio_services_status =
        gxos_nativeaot_find_export(&export_image,
                                   "GxManagedKernelInstallMmioServices",
                                   &install_mmio_services_resolution);
    GXOS_NATIVEAOT_EXPORT_STATUS run_phase13_status =
        gxos_nativeaot_find_export(&export_image, "GxManagedKernelRunPhase13",
                                   &run_phase13_resolution);
    ...
    if (install_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelInstallBootResources-export-missing");
    }
    if (boot_resources_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedQueryBootResources-export-missing");
    }
    if (memory_region_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedQueryMemoryRegion-export-missing");
    }
    ...
    if (install_device_inventory_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelInstallDeviceInventory-export-missing");
    }
    if (query_device_inventory_summary_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedQueryDeviceInventorySummary-export-missing");
    }
    if (query_device_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedQueryDevice-export-missing");
    }
    ...
    if (install_serial_services_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelInstallSerialServices-export-missing");
    }
    if (run_phase8_accounting_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelRunPhase8Accounting-export-missing");
    }
    ...
    if (install_input_services_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelInstallInputServices-export-missing");
    }
    ...
    if (run_phase11_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelRunPhase11-export-missing");
    }
    if (install_device_resources_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelInstallDeviceResources-export-missing");
    }
    if (query_device_resource_summary_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedQueryDeviceResourceSummary-export-missing");
    }
    if (query_device_resource_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedQueryDeviceResource-export-missing");
    }
    if (run_phase12_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelRunPhase12-export-missing");
    }
    if (install_mmio_services_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelInstallMmioServices-export-missing");
    }
    if (run_phase13_status != GXOS_NATIVEAOT_EXPORT_OK) {
        fail("GxManagedKernelRunPhase13-export-missing");
    }
    ...
    image->managed_kernel_install_device_inventory_rva =
        install_device_inventory_resolution.rva;
    image->managed_kernel_query_device_inventory_summary_rva =
        query_device_inventory_summary_resolution.rva;
    image->managed_kernel_query_device_rva = query_device_resolution.rva;
    ...
    image->managed_kernel_install_serial_services_rva =
        install_serial_services_resolution.rva;
    ...
    image->managed_kernel_install_input_services_rva =
        install_input_services_resolution.rva;
    ...
    image->managed_kernel_run_phase11_rva = run_phase11_resolution.rva;
    image->managed_kernel_install_device_resources_rva =
        install_device_resources_resolution.rva;
    image->managed_kernel_query_device_resource_summary_rva =
        query_device_resource_summary_resolution.rva;
    image->managed_kernel_query_device_resource_rva =
        query_device_resource_resolution.rva;
    image->managed_kernel_run_phase12_rva = run_phase12_resolution.rva;
    image->managed_kernel_install_mmio_services_rva =
        install_mmio_services_resolution.rva;
    image->managed_kernel_run_phase13_rva = run_phase13_resolution.rva;
}
#endif
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    uint32_t first_gc_status;
    uint32_t second_gc_status;
    int32_t first_gc_result;
    int32_t second_gc_result;
#endif
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
static void nativeaot_gc_emit_result(
    const char *result_name, const char *delta_name,
    const char *generation_name, const char *checksum_name,
    int32_t result)
{
    uint32_t encoded = (uint32_t)result;
    serial_field_hex(result_name, encoded);
    serial_text("\r\n");
    serial_field_hex(delta_name,
                     (encoded >> 16) & 0xFFU);
    serial_text("\r\n");
    serial_field_hex(generation_name,
                     (encoded >> 12) & 0x0FU);
    serial_text("\r\n");
    serial_field_hex(checksum_name,
                     encoded & 0x0FFFU);
    serial_text("\r\n");
}
    ...
    const char *prefix, const GXOS_SCHEDULER_TCB *thread)
{
    ...
    uint64_t teb = thread == 0 ? 0 : thread->teb_base;
    uint64_t teb_lower = teb == 0 ? 0 :
        *(const uint64_t *)(uintptr_t)(teb + 0x10U);
    uint64_t teb_upper = teb == 0 ? 0 :
        *(const uint64_t *)(uintptr_t)(teb + 0x08U);
    gxos_scheduler_capture_registers(&snapshot);
    serial_text(prefix);
    serial_field_hex("STACK_BASE=0x", thread == 0 ? 0 : thread->stack_base);
    serial_text("\r\n");
    serial_text(prefix);
    ...
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("RSP=0x", snapshot.rsp);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("TEB_LOWER=0x", teb_lower);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("TEB_UPPER=0x", teb_upper);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("CANARY0=0x", thread == 0 ? 0 :
                     ((const uint8_t *)(uintptr_t)thread->stack_canary_memory)[0]);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("CANARY15=0x", thread == 0 ? 0 :
                     ((const uint8_t *)(uintptr_t)thread->stack_canary_memory)[15]);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("TLS_ALLOC_LIMIT=0x", thread == 0 ? 0 :
                     *(const uint64_t *)(uintptr_t)(thread->tls_block_base + 0x30U));
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("TLS_ALLOC_PTR=0x", thread == 0 ? 0 :
                     *(const uint64_t *)(uintptr_t)(thread->tls_block_base + 0x38U));
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("UNWIND_CALLS=0x", g_nativeaot_gc_virtual_unwind_calls);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("UNWIND_FAILURES=0x", g_nativeaot_gc_virtual_unwind_failures);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("LAST_UNWIND_CONTEXT=0x", g_nativeaot_gc_last_unwind_context);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("LAST_UNWIND_CONTEXT_RSP=0x", g_nativeaot_gc_last_unwind_context_rsp);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("LAST_UNWIND_CONTEXT_RIP=0x", g_nativeaot_gc_last_unwind_context_rip);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("LAST_UNWIND_CONTROL_PC=0x", g_nativeaot_gc_last_unwind_control_pc);
    serial_text("\r\n");
    serial_text(prefix);
    serial_field_hex("FLUSH_CALLS=0x", g_nativeaot_gc_flush_process_write_buffers_calls);
    serial_text("\r\n");
    serial_text(prefix);
...
static uintptr_t EFIAPI nativeaot_scheduler_callback_thread_entry(void *argument)
{
    ...
    if (context->callback_count == 2U) {
        serial_text("GXOS_NET10:MANAGED_GC_WORKER_BEGIN\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_WORKER_SEED=0x", 0x51U);
        serial_text("\r\n");
        nativeaot_gc_emit_worker_state(
            "GXOS_NET10:MANAGED_GC_WORKER_BEFORE_", thread);
        g_phase = PHASE_IN_MANAGED;
        context->first_gc_status = (uint32_t)gxos_nativeaot_callback_invoke(
            &g_managed_gc_probe_bridge, 0x51, &context->first_gc_result);
        g_phase = PHASE_AFTER_MANAGED_RETURN;
        nativeaot_gc_emit_worker_state(
            "GXOS_NET10:MANAGED_GC_WORKER_AFTER_", thread);
        nativeaot_gc_emit_result(
            "GXOS_NET10:MANAGED_GC_WORKER_RESULT1=0x",
            "GXOS_NET10:MANAGED_GC_WORKER_COLLECTION_DELTA1=0x",
            "GXOS_NET10:MANAGED_GC_WORKER_GENERATION1=0x",
            "GXOS_NET10:MANAGED_GC_WORKER_CHECKSUM1=0x",
            context->first_gc_result);
        nativeaot_durability_require(
            context->first_gc_status == GXOS_NATIVEAOT_CALLBACK_OK &&
            gxos_nativeaot_gc_result_valid(context->first_gc_result, 0x51U,
                                      &gc_delta, &gc_generation, &gc_checksum),
            "nativeaot-scheduler-gc-first");
        (void)gc_generation;
        (void)gc_checksum;
        nativeaot_durability_require(gc_delta != 0,
                                     "nativeaot-scheduler-gc-first-collection");
        serial_text("GXOS_NET10:MANAGED_GC_WORKER_ATTACH_OK=1\r\n");
        serial_text("GXOS_NET10:MANAGED_GC_WORKER_ALLOC_OK=1\r\n");
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    serial_text("GXOS_NET10:MANAGED_GC_WORKER_REPEAT_BEGIN\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_WORKER_REPEAT_SEED=0x", 0x52U);
    serial_text("\r\n");
    nativeaot_gc_emit_worker_state(
        "GXOS_NET10:MANAGED_GC_WORKER_REPEAT_BEFORE_", thread);
    g_phase = PHASE_IN_MANAGED;
    context->second_gc_status = (uint32_t)gxos_nativeaot_callback_invoke(
        &g_managed_gc_probe_bridge, 0x52, &context->second_gc_result);
    g_phase = PHASE_AFTER_MANAGED_RETURN;
    nativeaot_gc_emit_worker_state(
        "GXOS_NET10:MANAGED_GC_WORKER_REPEAT_AFTER_", thread);
    nativeaot_gc_emit_result(
        "GXOS_NET10:MANAGED_GC_WORKER_RESULT2=0x",
        "GXOS_NET10:MANAGED_GC_WORKER_COLLECTION_DELTA2=0x",
        "GXOS_NET10:MANAGED_GC_WORKER_GENERATION2=0x",
        "GXOS_NET10:MANAGED_GC_WORKER_CHECKSUM2=0x",
        context->second_gc_result);
    nativeaot_durability_require(
        context->second_gc_status == GXOS_NATIVEAOT_CALLBACK_OK &&
        gxos_nativeaot_gc_result_valid(context->second_gc_result, 0x52U,
                                  &gc_delta, &gc_generation, &gc_checksum),
        "nativeaot-scheduler-gc-repeat");
    (void)gc_generation;
    (void)gc_checksum;
    nativeaot_durability_require(gc_delta != 0,
                                 "nativeaot-scheduler-gc-repeat-collection");
    serial_text("GXOS_NET10:MANAGED_GC_WORKER_REPEAT_OK=1\r\n");
#endif
...
static void nativeaot_scheduler_callback_probe(void)
{
    ...
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_BEFORE_VM_REGIONS=0x",
                     before.vm_region_count);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_VM_REGIONS=0x",
                     g_memory_vm_regions.live_count);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_THREAD_LIVE=0x",
                     thread->live);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_THREAD_STATE=0x",
                     thread->state);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_THREAD_FLS=0x",
                     thread->fls_values[g_nativeaot_runtime_fls_slot]);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_THREAD_TLS=0x",
                     thread->tls_block_base);
    serial_text("\r\n");
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    {
        uint32_t vm_regions_after_gc = g_memory_vm_regions.live_count;
        uint32_t canary_index = UINT32_MAX;
        uint32_t canary_side = 0;
        uint32_t canary_expected = 0;
        uint32_t canary_actual = 0;
        uint32_t canary_probe_index;
        uint32_t canaries_before_close;
        for (canary_probe_index = 0;
             canary_probe_index != GXOS_SCHEDULER_CANARY_BYTES;
             ++canary_probe_index) {
            ...
            if (canary_index == UINT32_MAX &&
                ...
                canary_side = 1;
                canary_expected = thread->low_canary[canary_probe_index];
                canary_actual = low_actual;
            }
            if (canary_index == UINT32_MAX &&
                high_actual != thread->high_canary[canary_probe_index]) {
                canary_index = canary_probe_index;
                canary_side = 2;
                canary_expected = thread->high_canary[canary_probe_index];
                canary_actual = high_actual;
            }
        }
        canaries_before_close = gxos_scheduler_check_canaries(thread);
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_CANARIES_BEFORE_CLOSE=0x",
                         canaries_before_close);
        serial_text("\r\n");
        nativeaot_durability_require(
        ...
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_CLOSE_RESULT=0x",
                         close_result);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_COLLECT_RESULT=0x",
                         collect_result);
        serial_text("\r\n");
        ...
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_THREAD_LIVE=0x",
                         thread->live);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_THREAD_FLS=0x",
                         thread->fls_values[g_nativeaot_runtime_fls_slot]);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_THREAD_TLS=0x",
                         thread->tls_block_base);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_HANDLE_LOOKUP=0x",
                         gxos_scheduler_thread_from_handle(handle) != 0);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_EXECUTION_REFS=0x",
                         thread->execution_refs);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_PUBLIC_REFS=0x",
                         thread->public_handle_refs);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_RUNNABLE=0x",
                         thread->runnable_queued);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_OBJECT_INTERNAL_REFS=0x",
                         object == 0 ? 0 : object->internal_refs);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_CANARIES=0x",
                         gxos_scheduler_check_canaries(thread));
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_AFTER_CLOSE_IS_CURRENT=0x",
                         gxos_scheduler_current_thread() == thread);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_CANARY_INDEX=0x",
                         canary_index);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_CANARY_SIDE=0x",
                         canary_side);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_CANARY_EXPECTED=0x",
                         canary_expected);
        serial_text("\r\n");
        serial_field_hex("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_CANARY_ACTUAL=0x",
                         canary_actual);
        serial_text("\r\n");
        nativeaot_durability_require(close_result && collect_result &&
                                     thread->live == 0 &&
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    serial_text("GXOS_NET10:MANAGED_GC_THREAD_RECLAIM_OK=1\r\n");
#endif
...
EFI_STATUS EFIAPI efi_main(EFI_HANDLE image_handle, EFI_SYSTEM_TABLE *system_table)
{
    ...
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_query_device_resolution = {0};
    ...
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_install_input_services_resolution = {0};
    ...
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_run_phase11_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_install_device_resources_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_query_device_resource_summary_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_query_device_resource_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_run_phase12_resolution = {0};
    GXOS_NATIVEAOT_EXPORT_RESOLUTION managed_kernel_install_mmio_services_resolution = {0};
    ...
    ManagedKernelQueryDeviceEntry managed_kernel_query_device;
    ...
    ManagedKernelInstallInputServicesEntry managed_kernel_install_input_services;
    ...
    ManagedKernelRunPhase11Entry managed_kernel_run_phase11;
    ManagedKernelInstallDeviceResourcesEntry managed_kernel_install_device_resources;
    ManagedKernelQueryDeviceResourceSummaryEntry managed_kernel_query_device_resource_summary;
    ManagedKernelQueryDeviceResourceEntry managed_kernel_query_device_resource;
    ManagedKernelRunPhase12Entry managed_kernel_run_phase12;
    ManagedKernelInstallMmioServicesEntry managed_kernel_install_mmio_services;
    ...
    GX_MANAGED_KERNEL_BOOT_RESOURCE_SUMMARY_V1 managed_kernel_boot_resource_summary = {0};
    GX_MANAGED_KERNEL_BOOT_RESOURCE_SUMMARY_V1 managed_kernel_boot_resource_repeat_summary = {0};
    GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 managed_kernel_memory_region = {0};
    GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 managed_kernel_memory_region_repeat = {0};
    GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1 managed_kernel_memory_region_small = {0};
    uint32_t managed_kernel_boot_resource_descriptor_count;
    uint32_t managed_kernel_boot_resource_middle_index;
    uint32_t managed_kernel_boot_resource_last_index;
    ...
    uint32_t managed_kernel_boot_resource_status;
    uint32_t managed_kernel_boot_resource_bad_version_status;
    uint32_t managed_kernel_boot_resource_null_status;
    uint32_t managed_kernel_boot_resource_small_status;
    uint32_t managed_kernel_boot_resource_overflow_status;
    uint32_t managed_kernel_boot_resource_repeat_status;
    uint32_t managed_kernel_memory_region_status;
    uint32_t managed_kernel_memory_region_repeat_status;
    uint32_t managed_kernel_memory_region_bad_version_status;
    uint32_t managed_kernel_memory_region_null_status;
    uint32_t managed_kernel_memory_region_small_status;
...
#endif
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    GXOS_NATIVEAOT_EXPORT_RESOLUTION gc_probe_resolution = {0};
    int32_t gc_main_result = 0;
    uint32_t gc_main_status = 0;
    uint32_t gc_main_delta = 0;
    uint32_t gc_main_generation = 0;
    uint32_t gc_main_checksum = 0;
    uint64_t gc_main_tls_alloc_limit_before = 0;
    uint64_t gc_main_tls_alloc_ptr_before = 0;
    ...
    managed_kernel_install_resolution.rva =
    ...
    managed_kernel_boot_resources_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_query_boot_resources_rva);
    managed_kernel_memory_region_resolution.rva =
        image.managed_kernel_query_memory_region_rva;
    managed_kernel_memory_region_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_query_memory_region_rva);
    managed_kernel_install_host_services_resolution.rva =
        image.managed_kernel_install_host_services_rva;
    ...
    managed_kernel_install_device_inventory_resolution.rva =
        image.managed_kernel_install_device_inventory_rva;
    managed_kernel_install_device_inventory_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_install_device_inventory_rva);
    managed_kernel_query_device_inventory_summary_resolution.rva =
        image.managed_kernel_query_device_inventory_summary_rva;
    managed_kernel_query_device_inventory_summary_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_query_device_inventory_summary_rva);
    managed_kernel_query_device_resolution.rva = image.managed_kernel_query_device_rva;
    managed_kernel_query_device_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_query_device_rva);
    ...
    managed_kernel_install_serial_services_resolution.rva =
        image.managed_kernel_install_serial_services_rva;
    managed_kernel_install_serial_services_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_install_serial_services_rva);
    managed_kernel_run_phase8_accounting_resolution.rva =
        image.managed_kernel_run_phase8_accounting_rva;
    managed_kernel_run_phase8_accounting_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_run_phase8_accounting_rva);
    ...
    managed_kernel_install_input_services_resolution.rva =
        image.managed_kernel_install_input_services_rva;
    managed_kernel_install_input_services_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_install_input_services_rva);
    ...
    managed_kernel_run_phase11_resolution.rva = image.managed_kernel_run_phase11_rva;
    managed_kernel_run_phase11_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_run_phase11_rva);
    managed_kernel_install_device_resources_resolution.rva =
        image.managed_kernel_install_device_resources_rva;
    managed_kernel_install_device_resources_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_install_device_resources_rva);
    managed_kernel_query_device_resource_summary_resolution.rva =
        image.managed_kernel_query_device_resource_summary_rva;
    managed_kernel_query_device_resource_summary_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_query_device_resource_summary_rva);
    managed_kernel_query_device_resource_resolution.rva =
        image.managed_kernel_query_device_resource_rva;
    managed_kernel_query_device_resource_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_query_device_resource_rva);
    managed_kernel_run_phase12_resolution.rva = image.managed_kernel_run_phase12_rva;
    managed_kernel_run_phase12_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_run_phase12_rva);
    managed_kernel_install_mmio_services_resolution.rva =
        image.managed_kernel_install_mmio_services_rva;
    managed_kernel_install_mmio_services_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_install_mmio_services_rva);
    managed_kernel_run_phase13_resolution.rva = image.managed_kernel_run_phase13_rva;
    managed_kernel_run_phase13_resolution.address =
        (uintptr_t)(image.actual_base + image.managed_kernel_run_phase13_rva);
    ...
    managed_kernel_install_device_inventory =
        (ManagedKernelInstallDeviceInventoryEntry)
        managed_kernel_install_device_inventory_resolution.address;
    managed_kernel_query_device_inventory_summary =
        (ManagedKernelQueryDeviceInventorySummaryEntry)
        managed_kernel_query_device_inventory_summary_resolution.address;
    managed_kernel_query_device = (ManagedKernelQueryDeviceEntry)
        managed_kernel_query_device_resolution.address;
    ...
    managed_kernel_install_serial_services =
        (ManagedKernelInstallSerialServicesEntry)
            managed_kernel_install_serial_services_resolution.address;
    managed_kernel_run_phase8_accounting =
        (ManagedKernelRunPhase8AccountingEntry)
            managed_kernel_run_phase8_accounting_resolution.address;
    ...
    managed_kernel_install_input_services =
        (ManagedKernelInstallInputServicesEntry)
            managed_kernel_install_input_services_resolution.address;
    ...
    managed_kernel_run_phase10 = (ManagedKernelRunPhase10Entry)
        managed_kernel_run_phase10_resolution.address;
    managed_kernel_run_phase11 = (ManagedKernelRunPhase11Entry)
        managed_kernel_run_phase11_resolution.address;
    managed_kernel_install_device_resources =
        (ManagedKernelInstallDeviceResourcesEntry)
        managed_kernel_install_device_resources_resolution.address;
    managed_kernel_query_device_resource_summary =
        (ManagedKernelQueryDeviceResourceSummaryEntry)
        managed_kernel_query_device_resource_summary_resolution.address;
    managed_kernel_query_device_resource =
        (ManagedKernelQueryDeviceResourceEntry)
        managed_kernel_query_device_resource_resolution.address;
    managed_kernel_run_phase12 = (ManagedKernelRunPhase12Entry)
        managed_kernel_run_phase12_resolution.address;
    managed_kernel_install_mmio_services =
        (ManagedKernelInstallMmioServicesEntry)
            managed_kernel_install_mmio_services_resolution.address;
    managed_kernel_run_phase13 = (ManagedKernelRunPhase13Entry)
        managed_kernel_run_phase13_resolution.address;
    ...
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_QUERY_EXPORT_RVA=0x",
                     image.managed_kernel_query_system_info_rva);
    serial_text("\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_INSTALL_BOOT_RESOURCES_EXPORT=GxManagedKernelInstallBootResources\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_INSTALL_BOOT_RESOURCES_EXPORT_RVA=0x",
                     image.managed_kernel_install_boot_resources_rva);
    serial_text("\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_QUERY_BOOT_RESOURCES_EXPORT=GxManagedQueryBootResources\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_QUERY_BOOT_RESOURCES_EXPORT_RVA=0x",
                     image.managed_kernel_query_boot_resources_rva);
    serial_text("\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_QUERY_MEMORY_REGION_EXPORT=GxManagedQueryMemoryRegion\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_QUERY_MEMORY_REGION_EXPORT_RVA=0x",
                     image.managed_kernel_query_memory_region_rva);
    serial_text("\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_INSTALL_HOST_SERVICES_EXPORT=GxManagedKernelInstallHostServices\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_INSTALL_HOST_SERVICES_EXPORT_RVA=0x",
                     image.managed_kernel_install_host_services_rva);
    serial_text("\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_START_EXPORT=GxManagedKernelStart\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_KERNEL_START_EXPORT_RVA=0x",
                     image.managed_kernel_start_rva);
    serial_text("\r\n");
#endif
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_CALLBACK
...
#endif
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    g_managed_gc_probe_target = image.actual_base + image.managed_gc_probe_rva;
    gc_probe_resolution.rva = image.managed_gc_probe_rva;
    gc_probe_resolution.address = (uintptr_t)g_managed_gc_probe_target;
    gc_probe_resolution.ordinal = 0;
    if (!gxos_nativeaot_callback_register(&g_managed_gc_probe_bridge,
                                         &gc_probe_resolution)) {
...
#endif
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    serial_text("GXOS_NET10:MANAGED_GC_PROBE_EXPORT=ManagedGcProbe\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_PROBE_EXPORT_RVA=0x",
                     image.managed_gc_probe_rva);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_PROBE_TARGET_VA=0x",
                     g_managed_gc_probe_target);
    serial_text("\r\n");
    ...
    if (g_load_library_import_descriptor_index != 2U ||
        ...
        g_load_library_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D200U)) {
    ...
    if (g_multibyte_import_descriptor_index != 2U ||
        ...
        g_multibyte_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D0C0U)) {
    ...
    if (g_memory_status_ex_import_descriptor_index != 2U ||
        ...
        g_memory_status_ex_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D258U)) {
    ...
    if (g_processor_topology_import_descriptor_index != 2U ||
        ...
        g_processor_topology_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D268U)) {
    ...
    if (g_virtual_alloc_import_descriptor_index != 2U ||
        ...
        g_virtual_alloc_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D0F8U) ||
        g_virtual_free_import_descriptor_index != 2U ||
        g_virtual_free_import_symbol_index != 0x19U ||
        g_virtual_free_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D100U)) {
    ...
    if (g_write_file_import_descriptor_index != 2U ||
        ...
        g_write_file_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D118U)) {
    ...
    if (g_co_get_apartment_type_import_descriptor_index != 3U ||
        ...
        g_co_get_apartment_type_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D408U) ||
        g_co_initialize_ex_import_descriptor_index != 3U ||
        g_co_initialize_ex_import_symbol_index != 1U ||
        g_co_initialize_ex_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D410U) ||
        g_co_uninitialize_import_descriptor_index != 3U ||
        g_co_uninitialize_import_symbol_index != 2U ||
        g_co_uninitialize_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D418U) ||
        g_co_wait_for_multiple_handles_import_descriptor_index != 3U ||
        g_co_wait_for_multiple_handles_import_symbol_index != 3U ||
        g_co_wait_for_multiple_handles_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D420U)) {
    ...
    if (g_set_event_import_descriptor_index != 2U ||
        g_set_event_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D0E0U) ||
        g_reset_event_import_descriptor_index != 2U ||
        g_reset_event_import_symbol_index != 0x28U ||
        g_reset_event_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D178U) ||
        g_wait_import_descriptor_index != 2U ||
        g_wait_import_symbol_index != 0x1AU ||
        g_wait_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D108U) ||
        g_wait_single_import_descriptor_index != 2U ||
        g_wait_single_import_symbol_index != 0x29U ||
        g_wait_single_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D180U)) {
    ...
    if (g_create_event_w_import_descriptor_index != 2U ||
        ...
        g_create_event_w_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D188U)) {
    ...
    if (g_memory_resource_notification_import_descriptor_index != 2U ||
        ...
        g_memory_resource_notification_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D1E8U)) {
    ...
    if (g_create_thread_import_descriptor_index != 2U ||
        ...
        g_create_thread_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D1A0U)) {
    ...
    if (g_set_thread_priority_import_descriptor_index != 2U ||
        ...
        g_set_thread_priority_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D1B0U)) {
    ...
    if (g_resume_thread_import_descriptor_index != 2U ||
        ...
        g_resume_thread_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D1C0U)) {
    ...
    if (g_is_process_in_job_import_descriptor_index != 2U ||
        ...
        g_is_process_in_job_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D290U)) {
    ...
    if (g_veh_add_import_descriptor_index != 2U ||
        ...
        g_veh_add_importing_iat_rva != GXOS_NATIVEAOT_IAT_RVA(0x7D128U)) {
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
    initialize_managed_kernel_mmio_service();
    initialize_managed_kernel_mmio_service_table();
...
#ifdef GXOS_ENABLE_MANAGED_KERNEL
    activate_nativeaot_tls();
    if (managed_kernel_start() != GX_MANAGED_NOT_INITIALIZED ||
        managed_kernel_install_host_services(
            GX_MANAGED_KERNEL_HOST_SERVICES_ABI_V1, 0) !=
            GX_MANAGED_NOT_INITIALIZED) {
        restore_nativeaot_tls();
        fail("managed-kernel-before-init-negative");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_START_BEFORE_INIT_REJECTED\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_HOST_SERVICES_BEFORE_INIT_REJECTED\r\n");
    restore_nativeaot_tls();
    activate_nativeaot_tls();
    managed_kernel_phase2_pre_main(
        managed_kernel_initialize, managed_kernel_query_system_info,
        managed_kernel_install_boot_resources,
        managed_kernel_query_boot_resources, managed_kernel_query_memory_region,
    ...
    managed_kernel_set_boot_resource_publication(
        &managed_kernel_boot_resource_publication,
        &g_managed_kernel_boot_resource_summary,
        g_managed_kernel_boot_resource_regions,
        g_managed_kernel_boot_resource_summary.RegionCount,
        (uint64_t)g_managed_kernel_boot_resource_summary.RegionCount *
            GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1_SIZE);
    managed_kernel_boot_resource_repeat_status = managed_kernel_install_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        (uintptr_t)&managed_kernel_boot_resource_publication);
    if (managed_kernel_boot_resource_repeat_status !=
            GX_MANAGED_ALREADY_INITIALIZED) {
        restore_nativeaot_tls();
        fail("managed-kernel-boot-resource-repeat-publication");
    }

    managed_kernel_boot_resource_summary.Size = 0xC3C3C3C3U;
    managed_kernel_boot_resource_summary.AbiVersion = 0xC3C3C3C3U;
    managed_kernel_boot_resource_summary.ServiceVersion = 0xC3C3C3C3U;
    managed_kernel_boot_resource_summary.Architecture = 0xC3C3C3C3U;
    managed_kernel_boot_resource_summary.RegionCount = 0xC3C3C3C3U;
    managed_kernel_boot_resource_summary.ResourceMapIdentity = 0xC3C3C3C3U;
    managed_kernel_boot_resource_summary.TotalPhysicalBytes = 0xC3C3C3C3C3C3C3C3ULL;
    managed_kernel_boot_resource_summary.UsablePhysicalBytes = 0xC3C3C3C3C3C3C3C3ULL;
    managed_kernel_boot_resource_summary.Capabilities = 0xC3C3C3C3C3C3C3C3ULL;
    managed_kernel_boot_resource_summary.Reserved = 0xC3C3C3C3C3C3C3C3ULL;
    managed_kernel_boot_resource_bad_version_status = managed_kernel_query_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1 + 1U,
        (uintptr_t)&managed_kernel_boot_resource_summary,
        sizeof(managed_kernel_boot_resource_summary));
    managed_kernel_boot_resource_null_status = managed_kernel_query_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1, 0,
        sizeof(managed_kernel_boot_resource_summary));
    managed_kernel_boot_resource_small_status = managed_kernel_query_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        (uintptr_t)&managed_kernel_boot_resource_summary,
        GX_MANAGED_KERNEL_BOOT_RESOURCE_SUMMARY_V1_SIZE - 1U);
    managed_kernel_boot_resource_overflow_status = managed_kernel_query_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        UINTPTR_MAX - 15U,
        GX_MANAGED_KERNEL_BOOT_RESOURCE_SUMMARY_V1_SIZE);
    if (managed_kernel_boot_resource_bad_version_status != GX_MANAGED_UNSUPPORTED_ABI ||
        managed_kernel_boot_resource_null_status != GX_MANAGED_INVALID_ARGUMENT ||
        managed_kernel_boot_resource_small_status != GX_MANAGED_BUFFER_TOO_SMALL ||
        managed_kernel_boot_resource_overflow_status != GX_MANAGED_INVALID_ARGUMENT ||
        managed_kernel_boot_resource_summary.Size != 0xC3C3C3C3U ||
        managed_kernel_boot_resource_summary.RegionCount != 0xC3C3C3C3U ||
        managed_kernel_boot_resource_summary.Reserved != 0xC3C3C3C3C3C3C3C3ULL) {
        restore_nativeaot_tls();
        fail("managed-kernel-boot-resource-summary-negative");
    }

    managed_kernel_boot_resource_status = managed_kernel_query_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        (uintptr_t)&managed_kernel_boot_resource_summary,
        sizeof(managed_kernel_boot_resource_summary));
    if (managed_kernel_boot_resource_status != GX_MANAGED_OK ||
        !managed_kernel_summary_matches_authority(
            &managed_kernel_boot_resource_summary)) {
        restore_nativeaot_tls();
        fail("managed-kernel-boot-resource-summary");
    }
    managed_kernel_boot_resource_descriptor_count =
        managed_kernel_boot_resource_summary.RegionCount;
    managed_kernel_boot_resource_middle_index =
        managed_kernel_boot_resource_descriptor_count / 2U;
    managed_kernel_boot_resource_last_index =
        managed_kernel_boot_resource_descriptor_count - 1U;
    serial_text("GXOS_NET10:MANAGED_KERNEL_BOOT_RESOURCES_OK\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_BOOT_RESOURCE_DESCRIPTOR_COUNT=0x",
                     managed_kernel_boot_resource_descriptor_count);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_BOOT_RESOURCE_TOTAL_PHYSICAL=0x",
                     managed_kernel_boot_resource_summary.TotalPhysicalBytes);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_BOOT_RESOURCE_USABLE_PHYSICAL=0x",
                     managed_kernel_boot_resource_summary.UsablePhysicalBytes);
    serial_text("\r\n");

    managed_kernel_boot_resource_repeat_summary.Size = 0x5A5A5A5AU;
    managed_kernel_boot_resource_repeat_summary.RegionCount = 0x5A5A5A5AU;
    managed_kernel_boot_resource_repeat_status = managed_kernel_query_boot_resources(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        (uintptr_t)&managed_kernel_boot_resource_repeat_summary,
        sizeof(managed_kernel_boot_resource_repeat_summary));
    if (managed_kernel_boot_resource_repeat_status != GX_MANAGED_OK ||
        !managed_kernel_summary_matches_authority(
            &managed_kernel_boot_resource_repeat_summary) ||
        managed_kernel_boot_resource_repeat_summary.Size !=
            managed_kernel_boot_resource_summary.Size ||
        managed_kernel_boot_resource_repeat_summary.TotalPhysicalBytes !=
            managed_kernel_boot_resource_summary.TotalPhysicalBytes) {
        restore_nativeaot_tls();
        fail("managed-kernel-boot-resource-repeat-query");
    }

    managed_kernel_memory_region_status = managed_kernel_query_memory_region(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1, 0,
        (uintptr_t)&managed_kernel_memory_region,
        sizeof(managed_kernel_memory_region));
    if (managed_kernel_memory_region_status != GX_MANAGED_OK ||
        !managed_kernel_region_matches_authority(
            0, &managed_kernel_memory_region)) {
        restore_nativeaot_tls();
        fail("managed-kernel-memory-region-first");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_MEMORY_REGION_OK\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_MEMORY_REGION_FIRST_OK\r\n");
    managed_kernel_emit_region_evidence(
        "MANAGED_KERNEL_MEMORY_REGION_FIRST", 0,
        &managed_kernel_memory_region);
    if (managed_kernel_boot_resource_descriptor_count > 2U) {
        managed_kernel_memory_region_status = managed_kernel_query_memory_region(
            GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
            managed_kernel_boot_resource_middle_index,
            (uintptr_t)&managed_kernel_memory_region,
        ...
        if (managed_kernel_memory_region_status != GX_MANAGED_OK ||
            !managed_kernel_region_matches_authority(
                ...
                &managed_kernel_memory_region)) {
            restore_nativeaot_tls();
            fail("managed-kernel-memory-region-middle");
        }
        serial_text("GXOS_NET10:MANAGED_KERNEL_MEMORY_REGION_MIDDLE_OK\r\n");
        managed_kernel_emit_region_evidence(
            "MANAGED_KERNEL_MEMORY_REGION_MIDDLE",
            managed_kernel_boot_resource_middle_index,
            &managed_kernel_memory_region);
    }
    managed_kernel_memory_region_status = managed_kernel_query_memory_region(
    ...
    if (managed_kernel_memory_region_status != GX_MANAGED_OK ||
        !managed_kernel_region_matches_authority(
            ...
            &managed_kernel_memory_region)) {
        restore_nativeaot_tls();
        fail("managed-kernel-memory-region-last");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_MEMORY_REGION_LAST_OK\r\n");
    managed_kernel_emit_region_evidence(
        "MANAGED_KERNEL_MEMORY_REGION_LAST",
        managed_kernel_boot_resource_last_index,
        &managed_kernel_memory_region);

    managed_kernel_memory_region_repeat_status = managed_kernel_query_memory_region(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        managed_kernel_boot_resource_last_index,
        (uintptr_t)&managed_kernel_memory_region_repeat,
        sizeof(managed_kernel_memory_region_repeat));
    if (managed_kernel_memory_region_repeat_status != GX_MANAGED_OK ||
        !managed_kernel_region_equal(&managed_kernel_memory_region,
                                     &managed_kernel_memory_region_repeat)) {
        restore_nativeaot_tls();
        fail("managed-kernel-memory-region-repeat");
    }

    fill_bytes((uint8_t *)&managed_kernel_memory_region_small, 0xA5,
               sizeof(managed_kernel_memory_region_small));
    managed_kernel_memory_region_small_status = managed_kernel_query_memory_region(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1, 0,
        (uintptr_t)&managed_kernel_memory_region_small,
        GX_MANAGED_KERNEL_BOOT_RESOURCE_REGION_V1_SIZE - 1U);
    managed_kernel_memory_region_null_status = managed_kernel_query_memory_region(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1, 0, 0,
        sizeof(managed_kernel_memory_region_small));
    managed_kernel_memory_region_bad_version_status = managed_kernel_query_memory_region(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1 + 1U, 0,
        (uintptr_t)&managed_kernel_memory_region_small,
        sizeof(managed_kernel_memory_region_small));
    managed_kernel_memory_region_equal_count_status = managed_kernel_query_memory_region(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        managed_kernel_boot_resource_descriptor_count,
        (uintptr_t)&managed_kernel_memory_region_small,
        sizeof(managed_kernel_memory_region_small));
    managed_kernel_memory_region_greater_count_status = managed_kernel_query_memory_region(
        GX_MANAGED_KERNEL_BOOT_RESOURCES_ABI_V1,
        managed_kernel_boot_resource_descriptor_count + 1U,
        (uintptr_t)&managed_kernel_memory_region_small,
        sizeof(managed_kernel_memory_region_small));
    if (managed_kernel_memory_region_small_status != GX_MANAGED_BUFFER_TOO_SMALL ||
        managed_kernel_memory_region_null_status != GX_MANAGED_INVALID_ARGUMENT ||
        managed_kernel_memory_region_bad_version_status != GX_MANAGED_UNSUPPORTED_ABI ||
        managed_kernel_memory_region_equal_count_status != GX_MANAGED_OUT_OF_RANGE ||
        managed_kernel_memory_region_greater_count_status != GX_MANAGED_OUT_OF_RANGE ||
        managed_kernel_memory_region_small.Size != 0xA5A5A5A5U ||
        managed_kernel_memory_region_small.BaseAddress != 0xA5A5A5A5A5A5A5A5ULL) {
        restore_nativeaot_tls();
        fail("managed-kernel-memory-region-negative");
    }
    serial_text("GXOS_NET10:MANAGED_KERNEL_BOOT_RESOURCE_NEGATIVE_TESTS_OK\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_MEMORY_MAP_MATCH\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_PHASE1_PASS\r\n");
    serial_text("GXOS_NET10:MANAGED_KERNEL_PHASE2_PASS\r\n");
    restore_nativeaot_tls();
#endif
#ifdef GXOS_ENABLE_MANAGED_KERNEL
    activate_nativeaot_tls();
    ...
    restore_nativeaot_tls();
    activate_nativeaot_tls();
    managed_kernel_phase6_inventory(
        managed_kernel_install_device_inventory,
        managed_kernel_query_device_inventory_summary,
        managed_kernel_query_device, managed_kernel_run_phase6);
    restore_nativeaot_tls();
    activate_nativeaot_tls();
    managed_kernel_phase12_resources(
        managed_kernel_install_device_resources,
        managed_kernel_query_device_resource_summary,
        managed_kernel_query_device_resource, managed_kernel_run_phase12);
    restore_nativeaot_tls();
    activate_nativeaot_tls();
    ...
    managed_kernel_phase13_mmio(
        managed_kernel_install_mmio_services, managed_kernel_run_phase13);
    restore_nativeaot_tls();
    activate_nativeaot_tls();
    if (managed_kernel_run_phase12(2U) != GX_MANAGED_OK) {
        restore_nativeaot_tls();
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    if (!gxos_nativeaot_callback_mark_ready(&g_managed_gc_probe_bridge)) {
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    serial_text("GXOS_NET10:MANAGED_GC_PROBE_ROOT_POLICY=MANAGED_STACK_LOCAL\r\n");
    serial_text("GXOS_NET10:MANAGED_GC_PROBE_ALLOCATION_POLICY=FIVE_BOUNDED_ARRAYS\r\n");
#endif
    install_fault_handlers();
...
#ifdef GXOS_ENABLE_NATIVEAOT_MANAGED_GC_PROBE
    serial_text("GXOS_NET10:MANAGED_GC_MAIN_BEGIN\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_MAIN_SEED=0x", 0x31U);
    serial_text("\r\n");
    gc_main_tls_alloc_limit_before =
        *(const uint64_t *)(uintptr_t)(g_tls_block + 0x30U);
    gc_main_tls_alloc_ptr_before =
        *(const uint64_t *)(uintptr_t)(g_tls_block + 0x38U);
    activate_nativeaot_tls();
    g_phase = PHASE_IN_MANAGED;
    gc_main_status = (uint32_t)gxos_nativeaot_callback_invoke(
        &g_managed_gc_probe_bridge, 0x31, &gc_main_result);
    g_phase = PHASE_AFTER_MANAGED_RETURN;
    gc_main_tls_alloc_limit_after =
        *(const uint64_t *)(uintptr_t)(g_tls_block + 0x30U);
    gc_main_tls_alloc_ptr_after =
        *(const uint64_t *)(uintptr_t)(g_tls_block + 0x38U);
    restore_nativeaot_tls();
    serial_field_hex("GXOS_NET10:MANAGED_GC_MAIN_TLS_ALLOC_LIMIT_BEFORE=0x",
                     gc_main_tls_alloc_limit_before);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_MAIN_TLS_ALLOC_PTR_BEFORE=0x",
                     gc_main_tls_alloc_ptr_before);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_MAIN_TLS_ALLOC_LIMIT_AFTER=0x",
                     gc_main_tls_alloc_limit_after);
    serial_text("\r\n");
    serial_field_hex("GXOS_NET10:MANAGED_GC_MAIN_TLS_ALLOC_PTR_AFTER=0x",
                     gc_main_tls_alloc_ptr_after);
    serial_text("\r\n");
    nativeaot_gc_emit_result(
        "GXOS_NET10:MANAGED_GC_MAIN_RESULT=0x",
        "GXOS_NET10:MANAGED_GC_MAIN_COLLECTION_DELTA=0x",
        "GXOS_NET10:MANAGED_GC_MAIN_GENERATION=0x",
        "GXOS_NET10:MANAGED_GC_MAIN_CHECKSUM=0x",
        gc_main_result);
    nativeaot_durability_require(
        gc_main_status == GXOS_NATIVEAOT_CALLBACK_OK &&
        gxos_nativeaot_gc_result_valid(gc_main_result, 0x31U,
                                  &gc_main_delta, &gc_main_generation,
                                  &gc_main_checksum),
        "nativeaot-main-gc-probe");
    nativeaot_durability_require(gc_main_delta != 0,
                                 "nativeaot-main-gc-collection");
    (void)gc_main_generation;
    (void)gc_main_checksum;
    serial_text("GXOS_NET10:MANAGED_GC_MAIN_OK=1\r\n");
    serial_text("GXOS_NET10:MANAGED_GC_ALLOCATION_OK=1\r\n");
    serial_text("GXOS_NET10:MANAGED_GC_COLLECTION_OBSERVED=1\r\n");
    serial_text("GXOS_NET10:MANAGED_GC_ROOT_SURVIVED=1\r\n");
#endif
#ifdef GXOS_ENABLE_NATIVEAOT_SCHEDULER_CALLBACK
